...
<cfset rc.orderTemplateCollectionList.setDisplayProperties('orderTemplateName,account.firstName,account.lastName,account.primaryEmailAddress.emailAddress,createdDateTime,calculatedTotal,scheduleOrderNextPlaceDateTime');
