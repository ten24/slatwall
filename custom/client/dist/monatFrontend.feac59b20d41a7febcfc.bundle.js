    ...
    function PromoModalController(rbkeyService, observerService, publicService, monatService, ModalService) {
        ...
        this.updateQuantity = function (sku, delta) {
            ...
            if ((_this.maxUseCount && _this.selectedPromotion.currentUseCount > _this.maxUseCount)
                || sku.addToCartQuantity > _this.maxUsePerItem
                || sku.addToCartQuantity < 0) {
        ...
        this.addToCart = function () {
            ...
            for (var sku in _this.rewardSkus) {
                if (sku.addToCartQuantity > 0) {
                    data.skuIds.push(sku.skuID);
                    data.quantities.push(sku.addToCartQuantity);
                }
            }
...
/******/ });
//# sourceMappingURL=monatFrontend.feac59b20d41a7febcfc.bundle.js.map