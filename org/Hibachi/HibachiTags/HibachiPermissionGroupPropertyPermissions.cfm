		...
		<cfloop array="#standardProperties#" index="propertyName">
			<tr class="#rowClass#">
				<cfif attributes.edit>
					...
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].permissionID" value="#thisPermission.getPermissionID()#" />
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].accessType" value="entity" />
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].entityClassName" value="#attributes.entityName#" />
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].propertyName" value="#propertyName#" />
		...
		<cfloop array="#entityProperties#" index="propertyName">
			<tr class="#rowClass#" onClick="$('.permission#lcase(subPropertyInheriting[ propertyName ])#').toggleClass('hide');">
				<cfif attributes.edit>
					...
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].permissionID" value="" />
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].accessType" value="entity" />
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].entityClassName" value="#attributes.entityName#" />
					<input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].propertyName" value="#propertyName#" />
					...
					<td><input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowCreateFlag" value=""><input type="checkbox" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowCreateFlag" class="hibachi-permission-checkbox" data-hibachi-parentcheckbox="propertypermission.permissions[#attributes.parentIndex#].allowCreateFlag" value="1"> Create</td>
					<td><input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowReadFlag" value=""><input type="checkbox" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowReadFlag" class="hibachi-permission-checkbox" data-hibachi-parentcheckbox="propertypermission.permissions[#attributes.parentIndex#].allowReadFlag" value="1"> Read</td>
					<td><input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowUpdateFlag" value=""><input type="checkbox" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowUpdateFlag" class="hibachi-permission-checkbox" data-hibachi-parentcheckbox="propertypermission.permissions[#attributes.parentIndex#].allowUpdateFlag" value="1"> Update</td>
					<td><input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowDeleteFlag" value=""><input type="checkbox" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowDeleteFlag" class="hibachi-permission-checkbox" data-hibachi-parentcheckbox="propertypermission.permissions[#attributes.parentIndex#].allowDeleteFlag" value="1"> Delete</td>
					<td><input type="hidden" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowProcessFlag" value=""><input type="checkbox" name="propertypermission.permissions[#request.context.permissionFormIndex#].allowProcessFlag" class="hibachi-permission-checkbox" data-hibachi-parentcheckbox="propertypermission.permissions[#attributes.parentIndex#].allowProcessFlag" value="1"> Process</td>
					<td></td>
				<cfelse>
					<td class="primary"><span class="depth#attributes.depth#" /><strong>#attributes.hibachiScope.getService('hibachiService').getEntityObject( attributes.entityName ).getPropertyTitle( propertyName )#</strong></td>
