...
<cfoutput>
    <span data-ng-controller="entity_createcollection as entity_createcollectionCtrl">
	<hb:HibachiEntityDetailForm object="#rc.collection#" edit="#rc.edit#">
		...
		<div class="s-top-spacer">
			<hb:HibachiPropertyRow>
				...
				<!--- inject angular here --->
				<cfset fieldAttributes = 'ng-model="entity_createcollectionCtrl.selectedOption.value" ng-change="entity_createcollectionCtrl.collectionObjectChanged()"'/>
				...
				<hb:HibachiPropertyList>
				    ...
				    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="baseCollectionID" name="baseCollectionID">
	                            <option></option>
                            </select>
                        </div>
				    </div>
