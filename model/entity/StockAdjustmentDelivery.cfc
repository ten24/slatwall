...
*/
component entityname="SlatwallStockAdjustmentDelivery" table="SwStockAdjustmentDelivery" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="stockService" hb_permission="stockAdjustment.stockAdjustmentDeliveries" {
