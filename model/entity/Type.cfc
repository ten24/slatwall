...
*/
component entityname="SlatwallType" table="SwType" persistent="true" accessors="true" output="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="typeService" hb_permission="this" hb_parentPropertyName="parentType" {
