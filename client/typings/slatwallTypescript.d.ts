...
/// <reference path="../../admin/client/ts/directives/frontend/slatwallAddressForm.ts" />
/// <reference path="../../admin/client/ts/directives/frontend/slatwallFormField.ts" />
/// <reference path="../../admin/client/ts/directives/frontend/slatwallLogin.ts" />
/// <reference path="../../admin/client/ts/directives/frontend/slatwallPropertyDisplay.ts" />
