...
*/
component displayname="Option Group" entityname="SlatwallOptionGroup" table="SwOptionGroup" persistent=true output=false accessors=true extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="optionService" hb_permission="this" {
