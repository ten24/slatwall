...
*/
component displayname="Stock" entityname="SlatwallStock" table="SwStock" persistent=true accessors=true output=false extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="stockService" {
