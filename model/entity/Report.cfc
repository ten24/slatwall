...
*/
component entityname="SlatwallReport" table="SwReport" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" hb_serviceName="hibachiReportService" {
