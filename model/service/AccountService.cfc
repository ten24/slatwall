...
component extends="HibachiService" accessors="true" output="false" {
	...
	public boolean function deleteAccountAddress(required any accountAddress) {
		...
		if(arguments.accountAddress.isDeletable()) {
			...
			// If the primary address is this address then set the primary to null
			if(!isNull(arguments.accountAddress.getAccount().getPrimaryShippingAddress())&&!isNull(arguments.accountAddress.getAccount().getPrimaryShippingAddress().getAccountAddressID()) && arguments.accountAddress.getAccount().getPrimaryShippingAddress().getAccountAddressID() eq arguments.accountAddress.getAccountAddressID()) {
				arguments.accountAddress.getAccount().setPrimaryShippingAddress(javaCast("null",""));
					arguments.accountAddress.removeAccount();
			}
			// If the primary address is this address then set the primary to null
			if(!isNull(arguments.accountAddress.getAccount().getPrimaryBillingAddress()) &&!isNull(arguments.accountAddress.getAccount().getPrimaryBillingAddress().getAccountAddressID()) && arguments.accountAddress.getAccount().getPrimaryBillingAddress().getAccountAddressID() eq arguments.accountAddress.getAccountAddressID()) {
