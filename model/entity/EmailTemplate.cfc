...
*/
component displayname="EmailTemplate" entityname="SlatwallEmailTemplate" table="SwEmailTemplate" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="templateService" hb_permission="this" {
