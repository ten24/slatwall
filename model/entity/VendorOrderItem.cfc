...
*/
component entityname="SlatwallVendorOrderItem" table="SwVendorOrderItem" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="vendorOrderService" hb_permission="vendorOrder.vendorOrderItems" {
