		...
		<hb:HibachiEntityDetailForm object="#rc.attributeOption#" edit="#rc.edit#"
			...
			<hb:HibachiEntityDetailGroup object="#rc.attributeOption#">
				...
				<cfif not rc.attributeOption.getNewFlag()>
					<hb:HibachiEntityDetailItem count="#rc.attributeOption.getAttributeValuesCount()#" view="admin:entity/attributeoptiontabs/entitycollection" open="false" text="#$.slatwall.rbKey('entity.' & rc.attribute.getAttributeSet().getAttributeSetObject())#" showOnCreateFlag=false />
				</cfif>
