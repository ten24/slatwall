<cfset page_title = "ImageCFC Documentation: flipVertical() method">
<cftry>
...
<h1>imageCFC.flipVertical()</h1>
<h4>Description</h4>
<p>Flips an image along the vertical axis.</p>
<h4>Returns</h4>
...
<p>flipVertical(objImage,inputFile,outputFile,jpegCompression)</p>
<table>
...
&lt;cfset imgInfo = imageCFC.flipVertical("", "C:\Inetpub\wwwroot\myimage.jpg", "C:\Inetpub\wwwroot\myimage.jpg")>
&lt;img src="myimage.jpg" alt="image flipped vertically"/>
</pre>
<cftry>
