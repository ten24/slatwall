...
<cfif thisTag.executionMode is "start">
	...
	<cfparam name="attributes.requiredFlag" type="boolean" default="false" />
	...
	<cfswitch expression="#attributes.fieldType#">
		...
		<cfcase value="text,email">
			<cfoutput>
				<input type="text" name="#attributes.fieldName#" value="#attributes.value#" class="form-control #attributes.fieldClass# <cfif attributes.requiredFlag == false>s-not-required</cfif>" #attributes.fieldAttributes# />
