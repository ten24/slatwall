			...
			<cfloop list="#attributes.fieldList#" index="thisField">
				...
				<cfif thisField eq "countryCode">
					<div class="form-group" data-sw-address="countryCode">
						<label for="countryCode">#request.slatwallScope.rbKey('entity.address.countryCode')#</label>
				...
				<cfif thisField eq "name">
					<div class="form-group" data-sw-property="name">
						<label for="name" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.name')#</label>
				...
				<cfif thisField eq "company">
					<div class="form-group" data-sw-property="company">
						<label class="control-label" for="company" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.company')#</label>
				...
				<cfif thisField eq "streetAddress">
					<div class="form-group#request.slatwallScope.getService('hibachiUtilityService').hibachiTernary(attributes.address.getCountry().getStreetAddressShowFlag(), '', ' hide')#" data-sw-property="streetAddress">
						<label for="streetAddress" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.streetAddress')#</label>
				...
				<cfif thisField eq "street2Address">
					<div class="form-group#request.slatwallScope.getService('hibachiUtilityService').hibachiTernary(attributes.address.getCountry().getStreet2AddressShowFlag(), '', ' hide')#" data-sw-property="street2Address">
						<label for="street2Address" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.street2Address')#</label>
				...
				<cfif thisField eq "locality">
					<div class="control-group#request.slatwallScope.getService('hibachiUtilityService').hibachiTernary(attributes.address.getCountry().getLocalityShowFlag(), '', ' hide')#" data-sw-property="locality">
						<label for="locality" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.locality')#</label>
				...
				<cfif thisField eq "city">
					<div class="form-group#request.slatwallScope.getService('hibachiUtilityService').hibachiTernary(attributes.address.getCountry().getCityShowFlag(), '', ' hide')#" data-sw-property="city">
						<label for="city" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.city')#</label>
				...
				<cfif thisField eq "stateCode">
					<div class="form-group#request.slatwallScope.getService('hibachiUtilityService').hibachiTernary(attributes.address.getCountry().getStateCodeShowFlag(), '', ' hide')#" data-sw-property="stateCode">
						<label for="stateCode" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.stateCode')#</label>
				...
				<cfif thisField eq "postalCode">
					<div class="form-group#request.slatwallScope.getService('hibachiUtilityService').hibachiTernary(attributes.address.getCountry().getPostalCodeShowFlag(), '', ' hide')#" data-sw-property="postalCode">
						<label for="postalCode" data-sw-label="true">#request.slatwallScope.rbKey('entity.address.postalCode')#</label>
