...
*/
component entityname="SlatwallState" table="SwState" persistent="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="addressService" hb_permission="this" {
