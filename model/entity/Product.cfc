...
component displayname="Product" entityname="SlatwallProduct" table="SwProduct" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="productService" hb_permission="this" hb_processContexts="addOptionGroup,addOption,addSubscriptionSku,deleteDefaultImage,updateDefaultImageFileNames,updateSkus,addProductReview" description="All top level information about a product and serves as the grouping for skus where price and inventory is managed" {
	...
	property name="startInCurrentPeriodFlag" ormtype="boolean" default="0";
  	property name="productFeaturedFlag" ormtype="boolean"  hb_formatType="yesno" default="0";
 ...
 property name="productManualSlamLock" ormtype="string";
 property name="productContact" ormtype="string";
 property name="productKeypull" ormtype="string";
 property name="productPullThrow" ormtype="string";
 property name="productKeyBlank" ormtype="string";
 ...
 property name="productFrameStyle" ormtype="string";
 ...
 property name="productHandingMount" ormtype="string";
 ...
 property name="productBuildable" ormtype="boolean" hb_formatType="yesno" default="No";	//CUSTOM PROPERTIES END
	...
	public any function getActiveSkuPricesForProductByCurrencyCode(required string currencyCode){
		...
		skuPriceCollectionList.addDisplayProperty('sku.skuID');
