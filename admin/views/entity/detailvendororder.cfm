	...
	<cf_HibachiEntityDetailForm object="#rc.vendorOrder#" edit="#rc.edit#" sRedirectAction="admin:entity.editvendororder">
		...
		<cf_HibachiPropertyRow>
			<cf_HibachiPropertyList>
				...
				<cf_HibachiPropertyDisplay object="#rc.vendorOrder#" property="vendor" autocompletePropertyIdentifiers="vendorName" fieldtype="textautocomplete" edit="#rc.vendorOrder.isNew()#">
