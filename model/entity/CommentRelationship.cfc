...
*/
component displayname="Comment Relationship" entityname="SlatwallCommentRelationship" table="SwCommentRelationship" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="commentService" hb_permission="comment.commentRelationships" {
