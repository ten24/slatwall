...
<cfoutput>
	...
	<hb:HibachiListingDisplay smartList="#rc.form.getAttributesSmartList()#"
	...
	<hb:HibachiActionCaller action="admin:entity.createattribute" class="btn btn-default" icon="plus" queryString="sRedirectAction=admin:entity.detailattributeset&formid=#rc.form.getFormID()#" modal=true />
