...
var SWCurrency = /** @class */ (function () {
    ...
    SWCurrency.Factory = function ($sce, $log, $hibachi, $filter) {
        ...
        function realFilter(value, currencyCode, decimalPlace, returnStringFlag) {
            ...
            try {
                var newValue = Number(value).toLocaleString(locale, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                value = newValue;
            }
            catch (e) {
            }
...
//# sourceMappingURL=hibachiFrontend.70f0cf2b45f0c36940c1.bundle.js.map