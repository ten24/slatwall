	...
	<cfswitch expression="#attributes.displaytype#">
		...
		<cfcase value="dl">
			<cfif attributes.edit>
				<cfoutput>
					<div class="<cfif attributes.requiredFlag>s-required</cfif>">
