		...
		<hb:HibachiPropertyRow>
			<hb:HibachiPropertyList>
    			...
    			<hb:HibachiDisplayToggle selector="input[name='newAccountFlag']" showValues="0" loadVisable="#!rc.processObject.getNewAccountFlag()#">
    				...
    				<hb:HibachiPropertyDisplay object="#rc.processObject#" property="accountID" autocompleteFilters="f:parentAccountRelationships.accountRelationshipID=null" autocompletePropertyIdentifiers="adminIcon,fullName,company,emailAddress,phoneNumber" edit="true">
			...
			<cfif structKeyExists(rc,'parentAccountID')>
				...
				<input type="hidden" name="fRedirectAction" value="admin:entity.preprocessaccount" />
				<input type="hidden" name="fRedirectQS" value="parentAccountID=#rc.parentAccountID#&processcontext=addaccountrelationship" />
			</cfif>
			<!--- Child Account --->
			<cfif structKeyExists(rc,'childAccountID')>
				<input type="hidden" name="childAccountID" value="#rc.childAccountID#" />
				<input type="hidden" name="sRedirectAction" value="admin:entity.detailAccount" />
				<input type="hidden" name="sRedirectQS" value="accountID=#rc.childAccountID#" />
			</cfif>
		</hb:HibachiPropertyRow>
