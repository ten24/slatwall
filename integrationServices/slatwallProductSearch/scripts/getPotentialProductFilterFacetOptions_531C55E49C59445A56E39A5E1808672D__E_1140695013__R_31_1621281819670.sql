	     ...
	     AND (siteID = '2c9680847491ce86017491f46ec50036' OR siteID IS NULL) AND (  productTypeID = '2c918086738dd3360173a1abdbca0469' ) AND (  brandName IN ('Sargent','LCN') ) 
	     ...
	     AND (siteID = '2c9680847491ce86017491f46ec50036' OR siteID IS NULL) AND (  productTypeID = '2c918086738dd3360173a1abdbca0469' ) AND (  brandName IN ('Sargent','LCN') ) 
	        ...
	        ( productPublishedStartDateTime IS NULL OR productPublishedStartDateTime <= '5/17/21 4:03 PM' )
            AND ( productPublishedEndDateTime IS NULL OR productPublishedEndDateTime >= '5/17/21 4:03 PM' )
	     AND (siteID = '2c9680847491ce86017491f46ec50036' OR siteID IS NULL) AND (  brandName IN ('Sargent','LCN') )
