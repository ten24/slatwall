                ...
                <div class="simplebar-content-wrapper">
                  <div class="simplebar-content simplebar-first-content" >
                    ...
                    <div class="widget widget-categories mb-4 pb-4 border-bottom">
                      <h3 class="widget-title"><a class="collapsed" href="##product-type" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="product-type">Product Type<span class="accordion-indicator"></span></a></h3>
                      <div class="accordion mt-n1" id="product-type">
                        <div class="card">
                    ...
                    <!---- Brand ----->
                    <div class="widget widget-categories mb-4 pb-4 border-bottom">
                      <h3 class="widget-title"><a class="collapsed" href="##product-brand" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="product-type">Brand<span class="accordion-indicator"></span></a></h3>

                      <div class="accordion mt-n1" id="shop-product-brand">
                        <div class="card">
                    ...
                    <!---- Style----->
                    <div class="widget widget-categories mb-4 pb-4 border-bottom">
                      <h3 class="widget-title"><a class="collapsed" href="##product-style" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="product-type">Style<span class="accordion-indicator"></span></a></h3>
                      <div class="accordion mt-n1" id="product-style">
                        <div class="card">
                    ...
                    <!---- Finish ----->
                    <div class="widget widget-categories mb-4 pb-4 border-bottom">
                      <h3 class="widget-title"><a class="collapsed" href="##product-finish" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="product-type">Finish<span class="accordion-indicator"></span></a></h3>
                      <div class="accordion mt-n1" id="product-finish">
                        <div class="card">
