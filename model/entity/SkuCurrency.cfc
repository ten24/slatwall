...
*/
component entityname="SlatwallSkuCurrency" table="SwSkuCurrency" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="skuService" hb_permission="sku.skuCurrencies" {
