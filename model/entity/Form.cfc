...
*/
component displayname="Form" entityname="SlatwallForm" table="SwForm" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="formService" hb_permission="this" hb_processContexts="addFormQuestion,addFormResponse"  {
