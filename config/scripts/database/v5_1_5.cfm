...
<cfif local.scriptHasErrors>
	<cflog file="Slatwall" text="General Log - Part of Script v5_1.5 had errors when running">
	<cfthrow detail="Part of Script v5_1.5 had errors when running">
<cfelse>
	<cflog file="Slatwall" text="General Log - Script v5_1.5 has run with no errors">
</cfif>
