...
*/
component displayname="Attribute Option" entityname="SlatwallAttributeOption" table="SwAttributeOption" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="attributeService" hb_property="attribute.attributeOptions" {
