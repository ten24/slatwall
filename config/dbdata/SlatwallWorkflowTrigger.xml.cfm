...
<Table tableName="SwWorkflowTrigger">
	<Columns>
		...
		<column name="scheduleCollectionID" />
		<column name="collectionFetchSize" update="false" />
		<column name="saveTriggerHistoryFlag" update="false" datatype="bit" />
	</Columns>
	<Records>
		...
		<Record workflowTriggerID="0089415672933e4687bbb92af51cbd04" triggerType="Schedule" startDateTime="2016-01-01 12:00:00" workflowID="d88c69962515821c6203bbbb8e0c1407" scheduleID="f92f7288669c5ad9590b5cd44eb3c11d" scheduleCollectionID="db4327e506000fde08cc4855fa14448b" collectionFetchSize="5" saveTriggerHistoryFlag="0" />
	</Records>
</Table>
