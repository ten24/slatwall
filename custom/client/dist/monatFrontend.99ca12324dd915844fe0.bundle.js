...
var MonatSearchController = /** @class */ (function () {
    ...
    function MonatSearchController($location, monatService, publicService, observerService, orderTemplateService) {
        ...
        this.getProductsByKeyword = function (keyword) {
            ...
            _this.publicService.doAction('getProductsByKeyword', { keyword: keyword, priceGroupCode: priceGroupCode }).then(function (data) {
                _this.observerService.notify('PromiseComplete');
...
var SWFPaginationController = /** @class */ (function () {
    // @ngInject
    SWFPaginationController.$inject = ["observerService", "$scope", "publicService"];
    function SWFPaginationController(observerService, $scope, publicService) {
        ...
        this.getNextPage = function (pageNumber, direction, newPages) {
            ...
            return _this.publicService.doAction(_this.action, _this.argumentsObject).then(function (result) {
                _this.recordList =
                    (result.productList)
                        ? result.productList
                        : (result.pageRecords)
...
var MonatProductListingController = /** @class */ (function () {
    // @ngInject
    MonatProductListingController.$inject = ["$rootScope", "publicService", "observerService", "monatService", "monatAlertService", "orderTemplateService"];
    function MonatProductListingController($rootScope, publicService, observerService, monatService, monatAlertService, orderTemplateService) {
        var _this = this;
        this.$rootScope = $rootScope;
        this.publicService = publicService;
        this.observerService = observerService;
...
/******/ });
//# sourceMappingURL=monatFrontend.99ca12324dd915844fe0.bundle.js.map