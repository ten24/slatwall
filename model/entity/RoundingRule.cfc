...
*/
component displayname="Rounding Rule" entityname="SlatwallRoundingRule" table="SwRoundingRule" persistent=true output=false accessors=true extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="roundingRuleService" hb_permission="this" {
