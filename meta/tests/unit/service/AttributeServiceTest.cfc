...
component extends="Slatwall.meta.tests.unit.SlatwallUnitTestBase" {
	...
	public void function setUp() {
		...
		variables.service = variables.mockService.getAttributeServiceMock();
	}
	...
	*/
	public void function saveAttributeTest_cacheClearedOnAttributeSave(){
		...
		assertFalse(variables.service.getHibachiCacheService().hasCachedValue('attributeService_getAttributeModel') == true);
		assertFalse(variables.service.getHibachiCacheService().hasCachedValue('attributeService_getAttributeModel_#attributeSet.getAttributeSetObject()#'));
		assertFalse(variables.service.getHibachiCacheService().hasCachedValue('attribtueService_getAttributeModel_#attributeSet.getAttributeSetObject()#_#attributeSet.getAttributeSetCode()#') == true);
	}
	...
	*/
	public void function getAttributeModelTest(){
		...
		assertFalse(variables.service.getHibachiCacheService().hasCachedValue('attributeService_getAttributeModel_Account'));
		...
		assert(variables.service.getHibachiCacheService().hasCachedValue('attributeService_getAttributeModel_Account'));
