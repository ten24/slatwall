...
*/
component displayname="Product Review" entityname="SlatwallProductReview" table="SwProductReview" persistent="true" output="false" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="productService" hb_permission="product.productReviews" {
