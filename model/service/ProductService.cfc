...
component extends="HibachiService" accessors="true" {
	...
	public array function getProductPublicProperties(){
		var publicProperties =  ['productID','productName','urlTitle', 'productCode', 'productDescription', 'productType.productTypeID', 'productType.productTypeIDPath', 'brand.brandID', 'brand.urlTitle'];
