...
*/
component displayname="FulfillmentBatchItem" entityname="SlatwallFulfillmentBatchItem" table="SwFulfillmentBatchItem" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="fulfillmentService" hb_permission="this" hb_processContexts="" {
