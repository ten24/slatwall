...
*/
component displayname="Promotion Account" entityname="SlatwallPromotionAccount" table="SwPromotionAccount" persistent="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" {
