...
*/
component displayname="Setting" entityname="SlatwallSetting" table="SwSetting" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="settingService" {
