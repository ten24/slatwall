...
*/
component displayname="Order Return" entityname="SlatwallOrderReturn" table="SwOrderReturn" persistent=true accessors=true output=false extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="orderService" hb_permission="order.orderReturns" hb_processContexts="receiveReturn,receive" {
