...
*/
component displayname="Measurement Unit" entityname="SlatwallMeasurementUnit" table="SwMeasurementUnit" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="measurementService" hb_permission="this" {
