...
*/
component entityname="SlatwallVendorAddress" table="SwVendorAddress" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="vendorService" hb_permission="vendor.vendorAddresses" {
