...
Notes:
	...
	orderItem 
*/
component entityname="SlatwallTaxApplied" table="SwTaxApplied" persistent="true" output="false" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="taxService" {
