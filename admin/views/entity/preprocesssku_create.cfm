...
<cfoutput>
	<cf_HibachiEntityProcessForm entity="#rc.processObject.getSku()#" edit="#rc.edit#">
		
		<cf_HibachiEntityActionBar type="preprocess" object="#rc.processObject.getSku()#"></cf_HibachiEntityActionBar>
