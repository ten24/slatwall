<cfset page_title = "ImageCFC Documentation: flipHorizontal() method">
<cftry>
...
<h1>imageCFC.flipHorizontal()</h1>
<h4>Description</h4>
<p>Flips an image along the horizontal axis.</p>
<h4>Returns</h4>
...
<p>flipHorizontal(objImage,inputFile,outputFile,jpegCompression)</p>
<table>
...
&lt;cfset imgInfo = imageCFC.flipHorizontal("", "C:\Inetpub\wwwroot\myimage.jpg", "C:\Inetpub\wwwroot\myimage.jpg")>
&lt;img src="myimage.jpg" alt="image flipped horizontally"/>
</pre>
<cftry>
