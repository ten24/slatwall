...
var MonatFilterMenuController = /** @class */ (function () {
    function MonatFilterMenuController(monatService) {
        ...
        this.$onInit = function () {
            _this.productFunction = _this.productFunction || 'getProducts';
        };
...
var MonatService = /** @class */ (function () {
    ...
    **/
    ...
    MonatService.prototype.updateCartPropertiesOnService = function (data) {
        ...
        this.totalItemQuantityAfterDiscount = 0;
        for (var _i = 0, _b = this.cart.orderItems; _i < _b.length; _i++) {
            var item = _b[_i];
            this.totalItemQuantityAfterDiscount += item.extendedPriceAfterDiscount;
        }
        if ((_a = this.cart['purchasePlusMessage']) === null || _a === void 0 ? void 0 : _a.message) {
...
/******/ });
//# sourceMappingURL=monatFrontend.036d63e0516e3114955e.bundle.js.map