...
*/
component entityname="SlatwallAccountPaymentApplied" table="SwAccountPaymentApplied" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" hb_serviceName="accountService" {
