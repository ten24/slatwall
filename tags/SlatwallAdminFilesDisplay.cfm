...
<cfif thisTag.executionMode is "start">
	...
	<div class="tab-pane" id="tabFiles">
		<cfoutput>
				...
				<cfloop array="#attributes.object.getFiles()#" index="fileRelation">
					<tr>
						...
						<td class="admin admin2">
							<cf_HibachiActionCaller action="admin:entity.downloadfile" queryString="fileID=#fileRelation.getFile().getFileID()#&redirectAction=#request.context.slatAction#&#attributes.object.getPrimaryIDPropertyName()#=#attributes.object.getPrimaryIDValue()#" modal="false" class="btn btn-default btn-mini" icon="download" iconOnly="true" />
							<cf_HibachiActionCaller action="admin:entity.editfile" queryString="fileID=#fileRelation.getFile().getFileID()#&baseObject=#attributes.object.getClassName()#&baseID=#attributes.object.getPrimaryIDValue()#&sRedirectAction=#request.context.slatAction#" class="btn btn-default btn-mini" icon="pencil" iconOnly="true" />
							<cf_HibachiActionCaller action="admin:entity.deletefilerelationship" querystring="fileRelationshipID=#fileRelation.getFileRelationshipID()#&redirectAction=#request.context.slatAction#&#attributes.object.getPrimaryIDPropertyName()#=#attributes.object.getPrimaryIDValue()#" class="btn btn-default btn-mini" iconOnly="true" icon="trash" confirm="true" />
						</td>
						</cfif>
					</tr>
				</cfloop>
			...
			<cfif attributes.adminFiles>
				<cf_HibachiActionCaller action="admin:entity.createfile" querystring="baseID=#attributes.object.getPrimaryIDValue()#&baseObject=#attributes.object.getClassName()#&sRedirectAction=#request.context.slatAction#" class="btn btn-default" icon="plus" />
			</cfif>
		</cfoutput>
	</div>
</cfif>
