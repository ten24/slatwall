						...
						<div class="btn-toolbar">
							...
							<cfelseif attributes.type eq "detail">
								...
								<cfelseif attributes.type eq "preprocess">
									...
									<div class="btn-group btn-group-sm">
										<button type="submit" class="btn btn-primary" ondblclick="this.disabled=true;">#attributes.hibachiScope.rbKey( "entity.#attributes.object.getClassName()#.process.#attributes.processContext#" )#</button>
									</div>
								</cfif>
