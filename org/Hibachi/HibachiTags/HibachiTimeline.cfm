		...
		<div class="table-responsive">	
			<table class="table table-bordered table-hover">
				<cfif arraylen(thisTag.auditArray)>
					...
					<cfif isObject(attributes.object) and attributes.object.hasProperty('createdDateTime') and attributes.object.getCreatedDateTime() lt attributes.auditCollectionList.getRecords()[arrayLen(attributes.auditCollectionList.getRecords())].getAuditDateTime()>
