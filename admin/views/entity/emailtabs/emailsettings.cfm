...
<cfoutput>
	<swa:SlatwallSettingTable>
		...
		<swa:SlatwallSetting settingName="emailSMTPServer" settingObject="#rc.email#" />
		<swa:SlatwallSetting settingName="emailSMTPPort" settingObject="#rc.email#" />
		<swa:SlatwallSetting settingName="emailSMTPUseSSL" settingObject="#rc.email#" />
		<swa:SlatwallSetting settingName="emailSMTPUseTLS" settingObject="#rc.email#" />
		<swa:SlatwallSetting settingName="emailSMTPUsername" settingObject="#rc.email#" />
		<swa:SlatwallSetting settingName="emailSMTPPassword" settingObject="#rc.email#" /
	</swa:SlatwallSettingTable>
</cfoutput>
