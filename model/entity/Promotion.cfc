...
*/
component displayname="Promotion" entityname="SlatwallPromotion" table="SwPromotion" persistent="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" hb_permission="this" {
