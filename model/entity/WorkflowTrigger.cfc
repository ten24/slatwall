...
*/
component entityname="SlatwallWorkflowTrigger" table="SwWorkflowTrigger" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" hb_serviceName="workflowService" hb_permission="workflow.workflowTriggers" {
