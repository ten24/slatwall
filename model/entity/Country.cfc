...
*/
component displayname="Country" entityname="SlatwallCountry" table="SwCountry" persistent="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="addressService" hb_permission="this" hb_defaultOrderProperty="countryName" {
