...
<cfoutput>
	...
	<hb:HibachiProcessCaller action="admin:entity.preprocesspermission" entity="#rc.permission#" processContext="addPermissionRecordRestriction" class="btn btn-default" icon="plus" modal="true" hideDisabled="false" />
</cfoutput>
