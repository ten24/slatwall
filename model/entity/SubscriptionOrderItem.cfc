...
*/
component entityname="SlatwallSubscriptionOrderItem" table="SwSubscriptionOrderItem" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="subscriptionService" {
