            ...
            SELECT 
    	        ...
    	        ( 
        			...
        			WHERE attributeOptionID IS NOT NULL
        			 AND  
	        ( productPublishedStartDateTime IS NULL OR productPublishedStartDateTime <= '5/17/21 3:51 PM' )
            AND ( productPublishedEndDateTime IS NULL OR productPublishedEndDateTime >= '5/17/21 3:51 PM' )
	     ...
	     AND (siteID = '2c9680847491ce86017491f46ec50036' OR siteID IS NULL) AND (  productTypeID = '2c91808575d3a3570175e6b5cfd1004d' )
	        ...
	        /** Time Took 8940673598 in fetching 166 records*/
