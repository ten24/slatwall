				...
				link: function(scope, element, attrs) {
					...
					existingCollectionsPromise.then(function(value) {
						...
						if (angular.isDefined(scope.filterItem.collectionID)) {
							...
							for (var i in scope.manyToManyOption) {
								if (scope.manyToManyOption[i].comparisonOperator === scope.filterItem.criteria) {
									scope.selectedFilterProperty.selectedCriteriaType = scope.manyToManyOption[i];
								}
							}
						}
					});
