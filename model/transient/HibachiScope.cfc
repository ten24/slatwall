...
component output="false" accessors="true" extends="Slatwall.org.Hibachi.HibachiScope" {
	...
	public any function getAvailableCartPropertyList() {
		return rereplace("orderID,orderOpenDateTime,calculatedTotal,subtotal,taxTotal,fulfillmentTotal,fulfillmentChargeAfterDiscountTotal,promotionCodeList,discountTotal,orderAndItemDiscountAmountTotal, fulfillmentDiscountAmountTotal, orderRequirementsList,
			...
			orderPayments.paymentMethod.paymentMethodID,orderPayments.paymentMethod.paymentMethodName, orderPayments.giftCard.balanceAmount, orderPayments.giftCard.giftCardCode, promotionCodes.promotionCode,promotionCodes.promotion.promotionName,eligiblePaymentMethodDetails.paymentMethod.paymentMethodName,eligiblePaymentMethodDetails.paymentMethod.paymentMethodType,eligiblePaymentMethodDetails.paymentMethod.paymentMethodID,eligiblePaymentMethodDetails.maximumAmount,attributeValues.attributeValue,attributeValues.attribute.attributeCode,assignedAttributeSets.attributes.attributeName,assignedAttributeSets.attributes.attributeCode,assignedAttributeSets.attributes.attributeID","\s","","ALL");
	}
