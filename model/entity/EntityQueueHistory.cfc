...
*/
component entityname="SlatwallEntityQueueHistory" table="SwEntityQueueHistory" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="HibachiEntityQueueService" {

	// Persistent Properties
	property name="entityQueueHistoryID" ormtype="string" length="32" fieldtype="id" generator="uuid" unsavedvalue="" default="";
