...
<cfparam name="baseObject" type="string">

<cfoutput>
	<cf_HibachiEntityDetailForm object="#rc.file#" edit="#rc.edit#" enctype="multipart/form-data" saveActionQueryString="#baseObject#ID=#rc[ '#baseObject#ID' ]#">
