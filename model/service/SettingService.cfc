...
component extends="HibachiService" output="false" accessors="true" {
	...
	public struct function getAllSettingMetaData() {
		...
		var allSettingMetaData = {
			...
			globalMaximumPromotionMessages = {fieldType="text", defaultValue=1, validate={dataType="numeric"}},
			globalMIMETypeWhiteList = {fieldtype="text", defaultValue="image/jpeg,image/png,image/gif,text/csv,application/pdf,application/rss+xml,application/msword,application/zip,text/plain,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"},
			...
			globalDefaultOrderByMaxRecordsLimit = { fieldType='text', defaultValue=100000, validate={dataType="numeric", required=true} },
			...
			globalPublicApiEntities = {fieldType="multiselect",defaultValue="Brand,GiftCard,Product,ProductType,Sku,SubscriptionBenefit"},
			// Image
