...
*/
component entityname="SlatwallOrderOrigin" table="SwOrderOrigin" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="settingService" hb_permission="this" {
