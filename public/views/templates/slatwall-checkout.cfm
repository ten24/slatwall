					...
					<cfelseif listFindNoCase(orderRequirementsList, "payment") or url.step eq 'payment'>
						...
						<ul class="nav nav-tabs" id="myTab">
							...
							<cfloop array="#eligiblePaymentMethods#" index="paymentDetails">
								<li class="#$.slatwall.getService('hibachiUtilityService').hibachiTernary(first, 'active', '')#"><a href="##tab#paymentDetails.paymentMethod.getPaymentMethodID()#" data-toggle="tab">Pay with #paymentDetails.paymentMethod.getPaymentMethodName()#</a></li>
								<cfset first = false />
							</cfloop>
						</ul>
						...
						<div class="tab-content">
							...
							<cfloop array="#eligiblePaymentMethods#" index="paymentDetails">
								...
								<div class="tab-pane#$.slatwall.getService('hibachiUtilityService').hibachiTernary(first, ' active', '')#" id="tab#paymentDetails.paymentMethod.getPaymentMethodID()#">
									...
									<cfelse>
										<form action="#paymentFormAction#" method="post">
											...
											<cfelseif paymentDetails.paymentMethod.getPaymentMethodType() eq "giftCard">
												...
												<sw:FormField valueObject="#addOrderPaymentObj#"
												                          fieldname="saveGiftCardToAccountFlag" valueObjectProperty="saveGiftCardToAccountFlag"
																		  value="yes"
												                          >
