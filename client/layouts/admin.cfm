...
<header class="navbar clearfix" id="header">
	<div class="container">
			<div class="navbar-brand">
				<!-- COMPANY LOGO -->
				<a href="index.html">
					<img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/logo/logo.png" alt="Cloud Admin Logo" class="img-responsive" height="30" width="120">
				</a>
				<!-- /COMPANY LOGO -->
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown" id="header-message">
					...
					<ul class="dropdown-menu inbox">
						...
						<li>
							<a href="##">
								<img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar2.jpg" alt="" />
								<span class="body">
						...
						<li>
							<a href="##">
								<img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar1.jpg" alt="" />
								<span class="body">
						...
						<li>
							<a href="##">
								<img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar8.jpg" alt="" />
								<span class="body">
				...
				<li class="dropdown user" id="header-user">
					<a href="##" class="dropdown-toggle" data-toggle="dropdown">
						<img alt="" src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar3.jpg" />
	  ...
	  <div id="teamslider">
		  <ul class="team-list">
			<li class="current">
			  ...
			  <span class="image">
				  <img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar3.jpg" alt="" />
			  </span>
			  <span class="title">
				You
			  </span>
			...
			<li>
			  <a href="javascript:void(0);">
			  <span class="image">
				  <img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar4.jpg" alt="" />
			  </span>
			  <span class="title">
				Ellie Doe
			  </span>
			...
			<li>
			  <a href="javascript:void(0);">
			  <span class="image">
				  <img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar5.jpg" alt="" />
			  </span>
			  <span class="title">
				Lisa Doe
			  </span>
			...
			<li>
			  <a href="javascript:void(0);">
			  <span class="image">
				  <img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar6.jpg" alt="" />
			  </span>
			  <span class="title">
				Kelly Doe
			  </span>
			...
			<li>
			  <a href="javascript:void(0);">
			  <span class="image">
				  <img src="#request.slatwallScope.getBaseURL()#/client/lib/cloud/img/avatars/avatar7.jpg" alt="" />
			  </span>
			  <span class="title">
				Jessy Doe
			  </span>
