...
component accessors="true" output="false" displayname="USPS" implements="Slatwall.integrationServices.ShippingInterface" extends="Slatwall.integrationServices.BaseShipping" {
	...
	public any function init() {
		...
		variables.shippingMethods = {
			...
			i17 = "Priority Mail Express International Legal Flat Rate Envelope",
			i18 = "Priority Mail International Gift Card Flat Rate Envelope",
			i19 = "Priority Mail International Window Flat Rate Envelope",
			i20 = "Priority Mail International Small Flat Rate Envelope",
			i21 = "First-Class Mail International Postcard",
			i22 = "Priority Mail International Legal Flat Rate Envelope",
			i23 = "Priority Mail International Padded Flat Rate Envelope",
			i24 = "Priority Mail International DVD Flat Rate Priced Box",
			i25 = "Priority Mail International Large Video Flat Rate Priced Box",
			i26 = "Priority Mail Express International Flat Rate Boxes",
