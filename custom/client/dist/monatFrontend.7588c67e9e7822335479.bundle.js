...
var SaveEnrollmentModalController = /** @class */ (function () {
    ...
    function SaveEnrollmentModalController(rbkeyService, observerService, publicService, monatAlertService) {
        ...
        this.saveEnrollment = function () {
            ...
            return _this.publicService.doAction('?slatAction=monat:public.saveEnrollment', data)
                .then(function (result) {
                if (result.errors) {
...
var HybridCartController = /** @class */ (function () {
    //@ngInject
    HybridCartController.$inject = ["monatService", "observerService", "orderTemplateService", "publicService", "$timeout"];
    function HybridCartController(monatService, observerService, orderTemplateService, publicService, $timeout) {
        var _this = this;
        this.monatService = monatService;
        this.observerService = observerService;
        this.orderTemplateService = orderTemplateService;
    ...
    HybridCartController.prototype.toggleCartOnAdd = function () {
        var _this = this;
        this.toggleCart();
        var currentState = this.showCart;
        this.timedToggle = this.timedToggle = this.$timeout(function () {
            if (currentState == _this.showCart) {
                _this.toggleCart();
            }
        }, 3000);
    };
...
module.exports = "\t<!---- Edit wishlist name modal --->\n\t<div class=\"modal using-modal-service\" id=\"edit-wishlist\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"edit-wishlist\" aria-hidden=\"true\">\n\t\t<div class=\"modal-dialog\" role=\"document\">\n\t\t\t<div class=\"modal-content p-0\">\n\t\t\t\t<div class=\"modal-header nameModal pb-3 bg-primary\">\n\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n\t\t\t\t\t\t<i class=\"fas text-white fa-times\"></i>\n\t\t\t\t\t</button>\n\t\t\t\t\t<p class=\"text-white h6 mb-0\"><span sw-rbKey=\"'frontend.enrollment.saveEnrollment'\"></span></p>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"modal-body row w-100\">\n\t\t\t\t\t<div class=\"m-3 p-3 justify-content-center align-items-center d-flex col-12\">\n\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t\t<label for=\"emailAddress\" sw-rbKey=\"'frontend.newAddress.emailAddress'\"></label>\n\t\t\t\t\t\t\t<input type=\"email\" name=\"emailAddress\" ng-model=\"saveEnrollmentModal.emailAddress\">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"modal-footer\">\n\t\t\t\t\t<button ng-class=\"{loading: saveEnrollmentModal.loading}\" ng-click=\"saveEnrollmentModal.saveEnrollment()\" value=\"{{frontend.wishlist.send}}\" class=\"btn bg-primary save-btn px-5 py-3\"><span sw-rbKey=\"'frontend.wishlist.send'\"></span></buton>\n\t\t\t\t\t<button ng-click=\"saveEnrollmentModal.close()\" type=\"button\" class=\"btn bg-primary py-3\"><span sw-rbKey=\"'frontend.wishlist.cancel'\"></span></button>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<!---- END: Edit wishlist name modal --->";
...
/******/ });
//# sourceMappingURL=monatFrontend.7588c67e9e7822335479.bundle.js.map