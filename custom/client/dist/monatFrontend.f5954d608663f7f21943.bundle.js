    ...
    function MonatService($q, $window, publicService, requestService, observerService, utilityService, localStorageCache, ModalService) {
        ...
        this.getPromotionRewardSkus = function (promotionRewardID) {
            ...
            if (_this.promotionRewardSkus[promotionRewardID]) {
                ...
                _this.publicService.doAction('getQualifiedPromotionRewardSkusForOrder', data).then(result, function (any) {
...
var PromoModalController = /** @class */ (function () {
    ...
    function PromoModalController(rbkeyService, observerService, publicService, monatService, ModalService) {
        ...
        this.viewSelectedPromotion = function () {
            _this.loading = true;
            _this.monatService.getPromotionRewardSkus(selectedPromotion.promotionRewardID).then(function (skuArray) {
...
/******/ });
//# sourceMappingURL=monatFrontend.f5954d608663f7f21943.bundle.js.map