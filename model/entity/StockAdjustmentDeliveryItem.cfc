...
*/
component entityname="SlatwallStockAdjustmentDeliveryItem" table="SwStockAdjustmentDeliveryItem" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="stockService" hb_permission="stockAdjustmentDelivery.stockAdjustmentDeliveryItems" {
