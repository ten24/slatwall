...
*/
component displayname="Promotion Applied" entityname="SlatwallPromotionApplied" table="SwPromotionApplied" persistent="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" {
