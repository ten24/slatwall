...
<Table tableName="SwWorkflowTask" dependencies="/config/dbdata/SlatwallWorkflow.xml.cfm">
	...
	<Records>
		...
		<Record workflowTaskID="c1cbd1a037444b9f96447a6a5347269c" activeFlag="1" taskName="Send Primary Email Address Notification" taskConditionsConfig='{"filterGroups":[{"filterGroup":[{"displayPropertyIdentifier":"","propertyIdentifier":"","comparisonOperator":"","value":"","breadCrumbs":[{"rbKey":"Account","entityAlias":"_account","cfc":"Account","propertyIdentifier":"_account"}]}]}],"baseEntityAlias":"_account","baseEntityName":"Account"}' workflowID="f8f3d033dd8444df85a92a8715b913a7" />
	</Records>
</Table>
