...
<Table tableName="SwEventTrigger">
	...
	<Records>
		...
		<Record eventTriggerID="4028288b4ed11133014ee47b9b7404d5" eventTriggerName="Send Gift Card to Recipient When Credited" eventTriggerType="email" eventTriggerObject="GiftCardTransaction" eventName="afterGiftCardProcess_creditSuccess" emailTemplateID="4028288b4ed11133014ee4950c6a04db">
	</Records>
</Table>