...
component output="false" accessors="true" extends="HibachiProcess" {
	...
	public any function getSkusSmartList() {
		if(!structKeyExists(variables, "skusSmartList")) {
			...
			variables.skusSmartList.addWhereCondition('aslatwallproducttype.productTypeIDPath like :baseproducttypeid', {baseproducttypeid=listFirst(this.getProduct().getProductType().getProductTypeIDPath()) & "%"});
		}
