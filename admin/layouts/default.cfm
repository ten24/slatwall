			...
			<div class="container-fluid">
				...
				<div id="slatwall-primary-nav">
					...
					<ul class="nav navbar-nav navbar-right">
						<hb:HibachiActionCallerDropdown title="" icon="cog icon-white" dropdownclass="pull-right" type="nav">
							<cfif $.slatwall.getLoggedInAsAdminFlag()>
			...
			<cfif $.slatwall.getLoggedInAsAdminFlag()>
				<aside class="{{sidebarClass}}" id="sidebar">
					...
					<nav class="sidebar-nav" ng-hide="searchResultsOpen">
						<ul id="menu" >
							<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.products_nav')#" icon="tags icon-white" type="sidenav">
							...
							<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.orders_nav')#" icon="inbox icon-white" type="sidenav">
								<hb:HibachiDividerHider>
							...
							<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.accounts_nav')#" icon="user icon-white" type="sidenav">
								<hb:HibachiDividerHider>
							...
							<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.warehouse_nav')#" icon="barcode icon-white" type="sidenav">
							...
							<cfif arrayLen(local.integrationSubsystems)>
								<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.integrations_nav')#" icon="random icon-white" type="sidenav">
							...
							<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.configure_nav')#" icon="cog icon-white" type="sidenav">
								<hb:HibachiDividerHider>
							...
							<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.tools_nav')#" icon="magnet icon-white" type="sidenav">
								<hb:HibachiDividerHider>
					...
					<ul class="nav navbar-nav">
						...
						<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.configure_nav')#" icon="cog icon-white" type="nav">
							<hb:HibachiDividerHider>
								...
								<hb:HibachiActionCaller action="admin:entity.listterm" type="list">
								<hb:HibachiActionCaller action="admin:entity.listtype" type="list">
								<hb:HibachiActionCaller action="admin:entity.listworkflow" type="list">
							</hb:HibachiDividerHider>
						</hb:HibachiActionCallerDropdown>
						<hb:HibachiActionCallerDropdown title="#$.slatwall.rbKey('admin.default.tools_nav')#" icon="magnet icon-white" type="nav">
							<hb:HibachiDividerHider>
								...
								<cfif $.slatwall.getAccount().getSuperUserFlag()>
									...
									<cf_HibachiActionCaller action="admin:main.encryptionreencryptdata" type="list" confirm="true" confirmText="#$.slatwall.rbKey('admin.main.encryptionreencryptdata_confirm')#">
