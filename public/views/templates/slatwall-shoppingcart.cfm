					...
					<form action="?s=1" method="post">
						...
						<table class="table">
							...
							<cfloop array="#$.slatwall.cart().getOrderItems()#" index="orderItem">
								...
								<input type="hidden" name="orderItems[#loopIndex#].orderItemID" value="#orderItem.getOrderItemID()#" />
								...
								<tr>
									...
									<td>
										<div class="form-group">
											<input type="text" class="form-control" name="orderItems[#loopIndex#].quantity" value="#orderItem.getQuantity()#" />
									...
									<td><a href="?slatAction=public:cart.removeOrderItem&orderItemID=#orderItem.getOrderItemID()#" class="btn" title="Remove Item"><span class="glyphicon glyphicon-remove-sign"></span></a></td>
								</tr>
							</cfloop>
						</table>
							...
							<cfloop array="#orderAttributeSets#" index="attributeSet">
								...
								<cfloop array="#attributeSet.getAttributes()#" index="attribute">
									...
									<div class="form-group">
										...
										<sw:FormField type="#attribute.getFormFieldType()#" name="#attribute.getAttributeCode()#" valueObject="#attributeValueObject#" valueObjectProperty="attributeValue" valueOptions="#attributeValueObject.getAttributeValueOptions()#" fieldAttributes=' class="form-control"' />
						...
						<div class="form-group pull-right">
							...
							<a href="?slatAction=public:cart.clear" class="btn btn-default">Clear Cart</a>

							<!--- Checkout, is just a simple link to the checkout page --->
							<a href="checkout.cfm" class="btn btn-primary">Checkout</a>
						</div>
				...
				<div class="col-md-4">
					<div class="well">
							...
							<table class="table">
								...
								<cfloop array="#$.slatwall.cart().getPromotionCodes()#" index="promotionCode">
									...
									<tr>
										...
										<td><a href="?slatAction=public:cart.removePromotionCode&promotionCodeID=#promotionCode.getPromotionCodeID()#" class="btn" title="Remove Promotion Code"><span class="glyphicon glyphicon-remove-sign"></span></a></td>
									</tr>
								</cfloop>
							</table>
						</cfif>
						...
						<form action="?s=1" method="post">
							...
							<div class="form-group">
								<sw:FormField type="text" name="promotionCode" valueObject="#addPromotionCodeObj#" valueObjectProperty="promotionCode" fieldAttributes=' class="form-control" placeholder="Enter Promo Code Here."' />
								<sw:ErrorDisplay object="#addPromotionCodeObj#" errorName="promotionCode" />
							</div>

							<!--- Add Promo Code Button --->
							<div class="form-group">
								<button type="submit" class="btn btn-default">Add Promo Code</button>
							</div>
						</form>
