...
*/
component entityname="SlatwallAudit" table="SwAudit" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" hb_serviceName="HibachiAuditService" hb_defaultOrderProperty="auditDateTime" hb_auditable="false" {
