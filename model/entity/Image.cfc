...
*/
component displayname="Image" entityname="SlatwallImage" table="SwImage" persistent="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="imageService" {
