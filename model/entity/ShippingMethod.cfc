...
*/
component displayname="Shipping Method" entityname="SlatwallShippingMethod" table="SwShippingMethod" persistent=true output=false accessors=true extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="shippingService" hb_permission="fulfillmentMethod.shippingMethods" {
