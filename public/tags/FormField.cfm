	...
	<cfswitch expression="#attributes.type#">
		...
		<cfcase value="checkboxgroup">
			<cfoutput>
				...
				<cfloop array="#attributes.valueOptions#" index="option">
					...
					<div class="checkbox">
						<label>
							<input type="checkbox" name="#attributes.name#" value="#thisOptionValue#" class="#attributes.class#" <cfif listFindNoCase(attributes.value, thisOptionValue)> checked="checked"</cfif> #attributes.fieldAttributes# />
							#thisOptionName#
						</label>
					</div>
				</cfloop>
		...
		<cfcase value="multiselect">
			<cfoutput>
				...
				<select name="#attributes.name#" class="#attributes.class#" multiple #attributes.fieldAttributes#>
					<cfloop array="#attributes.valueOptions#" index="option">
						<cfset thisOptionValue = isSimpleValue(option) ? option : structKeyExists(option, 'value') ? structFind(option, 'value') : '' />
						<cfset thisOptionName = isSimpleValue(option) ? option : structFind(option, 'name') />
		...
		<cfcase value="radiogroup">
			<cfoutput>
				...
				<cfloop array="#attributes.valueOptions#" index="option">
						...
						<cfset thisOptionName = isSimpleValue(option) ? option : structFind(option, 'name') />
					<div class="radio">
						<label><input type="radio" name="#attributes.name#" value="#thisOptionValue#" class="#attributes.class#" <cfif attributes.value EQ thisOptionValue> checked="checked"</cfif> #attributes.fieldAttributes# /> #thisOptionName#</label>
					</div>
				</cfloop>
			</cfoutput>
		</cfcase>
		...
		<cfcase value="yesno">
			<cfoutput>
				<label class="radio-inline">
					<input type="radio" name="#attributes.name#" class="#attributes.class#" value="1" <cfif isBoolean(attributes.value) && attributes.value>checked="checked"</cfif> #attributes.fieldAttributes# /> #yesNoFormat(1)#
				</label>
				<label class="radio-inline">
					<input type="radio" name="#attributes.name#" class="#attributes.class#" value="0" <cfif (isboolean(attributes.value) && not attributes.value) || not isBoolean(attributes.value)>checked="checked"</cfif> #attributes.fieldAttributes# /> #yesNoFormat(0)#
				</label>
			</cfoutput>
		</cfcase>
	</cfswitch>
