	...
	/>		
	 ...
	 <sw-listing-display data-base-entity-name="AccruementCurrency"
			...
			<sw-listing-columns>
				...
				<sw-listing-column data-editable="true" data-property-identifier="pointQuantity"></sw-listing-column>
		</sw-listing-columns>
		...
		<sw-collection-configs>
			<sw-collection-config data-entity-name="AccruementCurrency"
				...
				<sw-collection-columns>
					...
					<sw-collection-column data-property-identifier="pointQuantity" data-is-exportable="false"  data-is-searchable="true" data-is-only-keyword-column="false" data-is-keyword-column="true"></sw-collection-column>
				</sw-collection-columns>
