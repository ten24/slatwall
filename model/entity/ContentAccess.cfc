...
*/
component displayname="Content Access" entityname="SlatwallContentAccess" table="SwContentAccess" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="contentService" {
