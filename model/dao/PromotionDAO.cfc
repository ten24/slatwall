	...
	<cffunction name = "getOrderItemSalePricePromotionRewardsQuery">
		...
		<cfloop query="orderItemDiscountsQuery">
			...
			<cfelseif orderItemDiscountsQuery.salePriceDiscountType EQ "amountOff">
				<cfset querySetCell(orderItemDiscountsQuery, "salePrice", val(precisionEvaluate(orderItemDiscountsQuery.originalPrice - orderItemDiscountsQuery.amount)), orderItemDiscountsQuery.currentRow )>
			<cfelseif orderItemDiscountsQuery.salePriceDiscountType EQ "percentageOff" >
				<cfset querySetCell(orderItemDiscountsQuery, "salePrice", val(precisionEvaluate(orderItemDiscountsQuery.originalPrice - ( orderItemDiscountsQuery.originalPrice * (round(orderItemDiscountsQuery.amount / 100)*100)/100))), orderItemDiscountsQuery.currentRow )>
			</cfif>
		</cfloop>
