...
<cfoutput>
	<div class="span6">
		...
		<cf_HibachiListingDisplay smartList="#rc.subscriptionUsageBenefit.getContentsOptionsSmartList()#" multiselectFieldName="contents" multiselectValues="#selectedContentIDs#" edit="#rc.edit#">
	...
	<div class="span6">
		...
		<cf_HibachiListingDisplay smartList="#rc.subscriptionUsageBenefit.getExcludedContentsOptionsSmartList()#" multiselectFieldName="excludedContents" multiselectValues="#selectedExcludedContentIDs#" edit="#rc.edit#">
			<cf_HibachiListingColumn propertyIdentifier="title" tdclass="primary" />
			<cf_HibachiListingColumn propertyIdentifier="site.siteName" />
		</cf_HibachiListingDisplay>	
	</div>
