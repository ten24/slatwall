...
<cfset rc.orderTemplateCollectionList.setDisplayProperties('orderTemplateName,account.calculatedFullName,createdDateTime,account.primaryEmailAddress.emailAddress,calculatedTotal,scheduleOrderNextPlaceDateTime',{isVisible=true,isSearchable=true,isDeletable=true}) />
