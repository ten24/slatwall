			...
			<div class="col-md-12">
				...
				<cfloop array="#$.slatwall.getBrand().getProductsSmartList().getPageRecords()#" index="product">
					...
					<div class="col-md-3">
						<div class="thumbnail">
							<!--- Product Image --->
							<img src="#product.getResizedImagePath(size='m')#" alt="#product.getCalculatedTitle()#" class="img-responsive" />
							...
							<cfif product.getPrice() gt product.getCalculatedSalePrice()>
								<p><span style="text-decoration:line-through;">#product.getPrice()#</span> <span class="text-danger">#product.getFormattedValue('calculatedSalePrice')#</span></p>
							<cfelse>
