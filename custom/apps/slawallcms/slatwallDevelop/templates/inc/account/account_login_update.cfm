...
<div>
	...
	<form ng-model="Account_UpdatePrimaryEmailAddress" ng-submit="swfForm.submitForm()" swf-form data-s-redirect-url="/my-account/login-information" data-method="updatePrimaryEmailAddress">
		...
		<div class="form-group">
			...
			<input name="emailAddress" class="form-control" ng-model="Account_UpdatePrimaryEmailAddress.emailAddress" swvalidationrequired="true" swvalidationdatatype="email"/>
		...
		<div class="form-group">
			...
			<input name="emailAddressConfirm" class="form-control" ng-model="Account_UpdatePrimaryEmailAddress.emailAddressConfirm" swvalidationrequired="true" swvalidationdatatype="email" swvalidationeqproperty="Account_UpdatePrimaryEmailAddress.emailAddress"/>
