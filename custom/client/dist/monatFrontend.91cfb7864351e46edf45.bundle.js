...
var PromoModalController = /** @class */ (function () {
    ...
    function PromoModalController(rbkeyService, observerService, publicService, monatService, ModalService) {
        ...
        this.formatRewardSkus = function (skuArray) {
            for (var sku in skuArray) {
                sku.title = sku.product_productName;
                sku.listPrice = parseInt(sku.listPrice) ? sku.listPrice : sku.skuPrices_price;
            }
        };
        this.closeModal = function () {
            _this.close(null);
...
/******/ });
//# sourceMappingURL=monatFrontend.91cfb7864351e46edf45.bundle.js.map