...
module slatwalladmin {
    ...
    export class swForm implements ng.IDirective {
		...
		replace = true;
		link = (scope) =>{scope.context = scope.context || 'save';console.log("Here it is:", Date.now());};
        
        constructor(public formService, private ProcessObject, private AccountFactory, private CartFactory, private $compile, private $templateCache, private $timeout, private $rootScope, private partialsPath, private $http){
