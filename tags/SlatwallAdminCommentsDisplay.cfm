	...
	<div class="tab-pane" id="tabComments">
		<cfoutput>
			...
			<cfif attributes.adminComments>
				<cf_HibachiActionCaller action="admin:entity.createcomment" querystring="#attributes.object.getPrimaryIDPropertyName()#=#attributes.object.getPrimaryIDValue()#&redirectAction=#request.context.slatAction#" modal="true" class="btn btn-default" icon="plus" />
			</cfif>
		</cfoutput>
	</div>
</cfif>
