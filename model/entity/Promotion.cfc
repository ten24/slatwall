...
component displayname="Promotion" entityname="SlatwallPromotion" table="SwPromotion" persistent="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" hb_permission="this" {
	...
	property name="ordersSmartList" type="any" persistent="false";

	// ============ START: Non-Persistent Property Methods =================

	public any function getOrdersSmartList(){
		if(!structKeyExists(variables, "ordersSmartList")){
			variables.ordersSmartList = getService("OrderService").getOrderSmartList();
			variables.ordersSmartList.joinRelatedProperty("SlatwallOrder", "appliedPromotions", "inner");
			variables.ordersSmartList.joinRelatedProperty("SlatwallPromotionApplied", "promotion", "inner");
			variables.ordersSmartList.addWhereCondition("aslatwallpromotion.promotionID='#this.getPromotionID()#'");
		}
		return variables.ordersSmartList;
	}
