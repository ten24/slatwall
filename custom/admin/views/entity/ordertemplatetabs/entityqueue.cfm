...
<cfoutput>
	...
	<div>
	    ...
	    <hb:HibachiActionCaller action="admin:entity.retryEntityQueueFailures" queryString="entityName=Order&orderID=#rc.orderTemplate.getPrimaryIDValue()#" class="btn btn-primary pull-right" type="link">
	</div>
