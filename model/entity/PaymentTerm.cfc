...
*/
component displayname="Payment Term" entityname="SlatwallPaymentTerm" table="SwPaymentTerm" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="paymentService" hb_permission="this" {
