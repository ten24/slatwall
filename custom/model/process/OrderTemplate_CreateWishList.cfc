...
*/
component output="false" accessors="true" extends="Slatwall.model.process.OrderTemplate_CreateWishList" {
	...
	public any function getSite() {
		...
		if(StructKeyExists(variables, 'site') && !isNull(variables['site']) ) {
