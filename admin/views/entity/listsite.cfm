...
<cfoutput>
	...
	<cf_HibachiListingDisplay smartList="#rc.siteSmartList#"
		...
		<cf_HibachiListingDisplayButtonGroup >
			<cf_HibachiProcessCaller action="admin:entity.createsite" entity="site" processContext="create" class="btn btn-primary" icon="plus icon-white" text="#$.slatwall.rbKey('define.add')# #$.slatwall.rbKey('entity.site')#" modal="true" />
		</cf_HibachiListingDisplayButtonGroup>
