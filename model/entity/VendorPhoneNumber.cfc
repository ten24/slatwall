...
*/
component entityname="SlatwallVendorPhoneNumber" table="SwVendorPhoneNumber" persistent="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="vendorService" hb_permission="vendor.vendorPhoneNumbers" {
