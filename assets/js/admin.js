			...
			if (invDataArr.length) {
				for(var i=0;i<invDataArr.length;i++) {
					...
					var newTR = ["<tr class='stock' data-parentlocationid='"+parentLocationID+"' data-parentlocationidpath='"+parentLocationIDPath+"'>", 
						...
						"<td>"+invData.QOH+"</td>",
						"<td>"+invData.QOSH+"</td>",
						"<td><a href='" + $.slatwall.buildUrl(action="entity.listorderitem", querystring="F:sku.skuid=" + invData.skuID + "&F:order.orderStatusType.systemCode=ostNew,ostOnHold,ostProcessing&F:orderItemType.systemCode=oitSale") + "'>"+invData.QNDOO+"</a></td>",
						"<td>"+invData.QNDORVO+"</td>",
						"<td>"+invData.QNDOSA+"</td>",
						"<td><a href='" + $.slatwall.buildUrl(action="entity.listorderitem", querystring="F:sku.skuid=" + invData.skuID + "&F:order.orderStatusType.systemCode=ostNew,ostOnHold,ostProcessing&F:orderItemType.systemCode=oitReturn") + "'>"+invData.QNRORO+"</a></td>",
						"<td>"+invData.QNROVO+"</td>",
						"<td><a href='" + $.slatwall.buildUrl(action="entity.liststockadjustmentitem", querystring="F:stockadjustment.stockadjustmentstatustype.systemCode=sastNew&F:toStock.sku.skuID=" + invData.skuID ) + "'>"+invData.QNROSA+"</a></td>",
						"<td>"+invData.QC+"</td>",
						"<td>"+invData.QE+"</td>",
						"<td>"+invData.QNC+"</td>",
						"<td>"+invData.QATS+"</td>",
