...
<cfoutput>
	<hb:HibachiEntityDetailForm object="#rc.physicalCount#" edit="#rc.edit#">
		...
		<hb:HibachiEntityDetailGroup object="#rc.physicalCount#">
			<hb:HibachiEntityDetailItem view="admin:entity/physicalcounttabs/basic" open="true" text="#$.slatwall.rbKey('admin.define.basic')#" showOnCreateFlag=true />
			<hb:HibachiEntityDetailItem view="admin:entity/physicalcounttabs/physicalcountitems" text="#$.slatwall.rbKey('entity.physicalCount.physicalCountItems')#" />
