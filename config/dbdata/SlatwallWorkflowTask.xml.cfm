...
<Table tableName="SwWorkflowTask" dependencies="/config/dbdata/SlatwallWorkflow.xml.cfm">
	...
	<Records>
		...
		<Record workflowTaskID="aa74f1619660a5f1018b19452cf24088" activeFlag="1" taskName="Create Subscritpion Order Deliveries" taskConditionsConfig='{"filterGroups":[{"filterGroup":[]}],"baseEntityAlias":"_product","baseEntityName":"Product"}' workflowID="a6c7740cb58189c914c2b2528aec7c1d" />
	</Records>
</Table>
