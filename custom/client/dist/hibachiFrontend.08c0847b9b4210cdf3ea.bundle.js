...
var SWCurrency = /** @class */ (function () {
    ...
    SWCurrency.Factory = function ($sce, $log, $hibachi, $filter) {
        ...
        function realFilter(value, currencyCode, decimalPlace, returnStringFlag) {
            ...
            try {
                var newValue = Number(value).toLocaleString(locale, { minimumFractionalDigits: minimumFractionalDigits });
                value = newValue;
            }
            catch (e) {
            }
...
//# sourceMappingURL=hibachiFrontend.08c0847b9b4210cdf3ea.bundle.js.map