...
<cfoutput>
	...
	<cf_HibachiListingDisplay smartlist="#rc.physicalSmartList#" 
		...
		<cf_HibachiProcessCaller action="admin:entity.createphysical" entity="physical" processContext="create" class="btn btn-primary" icon="plus icon-white" text="#$.slatwall.rbKey('define.add')# #$.slatwall.rbKey('entity.physical')#" modal="true" />
		</cf_HibachiListingDisplayButtonGroup>
