...
component extends="Slatwall.meta.tests.unit.SlatwallUnitTestBase" {
	...
	public void function run() {
		describe('RMA User Stories', function() {
			it("RMA003 - RMA Return Instructions Email to Customer", function() {
				expect(order.getOrderNumber()).notToBeNull();
			});

			it("RMA004 - RMA CS Reasons", function() {

			});

			it("RMA005 - RMA Ops Reasons", function() {

			});

			it("RMA011 - Do not allow refund for amount greater than original payment value", function() {
