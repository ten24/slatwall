	...
	<cfif isObject(attributes.collectionList)>
		<cfoutput>
			...
			<sw-listing-display
				...
				record-edit-action="admin:entity.edit#lcase(attributes.collectionlist.getCollectionObject())#"
