...
<cf_HibachiActionCaller action="admin:entity.createpricegrouprate" class="btn btn-default" icon="plus" queryString="pricegroupID=#rc.pricegroup.getpricegroupID()#" modal="true" />
