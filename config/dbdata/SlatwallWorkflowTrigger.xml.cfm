...
<Table tableName="SwWorkflowTrigger">
	<Columns>
		...
		<column name="runningFlag" update="false"/>
		<column name="timeout" update="false"/>
		<column name="nextRunDate" update="false"/>
	</Columns>
	<Records>
		...
		<Record workflowTriggerID="a8bcb9a9e2e52981cea92c599170e052" nextRunDate="2017-10-26 12:00:00" runningFlag="0" scheduleID="a7379771019d044026ae978809e1fd3d" timeout="90" triggerType="Schedule" startDateTime="2016-01-01 12:00:00" workflowID="a6c7740cb58189c914c2b2528aec7c1d" />
	</Records>
</Table>
