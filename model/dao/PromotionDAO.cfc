	...
	<cffunction name = "getOrderItemSalePricePromotionRewardsQuery">
		...
		<cfloop query="orderItemDiscountsQuery">
			...
			<cfelseif orderItemDiscountsQuery.salePriceDiscountType EQ "percentageOff" >
				<cfset querySetCell(orderItemDiscountsQuery, "salePrice", getService('HibachiUtilityService').precisionCalculate(orderItemDiscountsQuery.originalPrice - round(orderItemDiscountsQuery.originalPrice * orderItemDiscountsQuery.amount)/100), orderItemDiscountsQuery.currentRow )>
			</cfif>
		</cfloop>
