...
component displayname="Content" entityname="SlatwallContent" table="SwContent" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="contentService" hb_permission="this" hb_parentPropertyName="parentContent" hb_childPropertyName="childContents" hb_processContexts="createSku" {
	...
	property name="urlTitle" ormtype="string" length="255" index="PI_urltitle";
	property name="urlTitlePath" ormtype="string" length="255" index="PI_urltitlepath";
	...
	property name="listingPages" singularName="listingPage" cfc="ProductListingPage" fieldtype="one-to-many" fkcolumn="contentID" cascade="all-delete-orphan" inverse="true";
 ...
 property name="renderTemplateType" cfc="Type" fieldtype="many-to-one" fkcolumn="renderTemplateTypeID" hb_optionsSmartListData="f:parentType.typeID=2c91808778db92450178e96c01ed011e";
 property name="contentSubtitle" ormtype="string";
