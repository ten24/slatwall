...
<Table tableName="SwPaymentMethod" >
	...
	<Records>
		<Record paymentMethodID="444df303dedc6dab69dd7ebcc9b8036a" paymentMethodName="Credit Card" paymentMethodType="creditCard" activeFlag="1" sortOrder="1" allowSaveFlag="1" />
	</Records>
</Table>