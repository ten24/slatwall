		...
		<div style="z-index: 3000;" class="s-dialog-container">
			<div class="s-create-window">
				...
				<header class="s-create-window-header">
					<div class="navbar navbar-s-navbar-ten24 s-dialog-header">
						<ul class="navbar-brand">
							<li class="s-title"><i class="fa fa-calendar"></i> Add Order Item</li>
							<li class="s-bread-crumb">
								<ul class="list-unstyled list-inline">
									<li><a href="#">Region 10 - Leadership Development Conference</a></li>
								</ul>
							</li>
						</ul>
						<ul class="nav navbar-nav pull-right">
							<li class="s-total">Total: <span class="s-price">$1200.00</span></li>
				...
				<div class="col-xs-12 s-create-window-body">
									...
									<div class="row s-content-row">
										...
										<div class="col-md-6 s-content-item">
											...
											<div class="form-group">
												<label>Price:</label>
												<input class="form-control" type="text" value="$1200.00" disabled>
											</div>
											<div class="form-group">
												...
												<table class="table table-condensed s-info-table">
													<tbody>
														<tr class="s-table-header">
															<td colspan="2" class="table-section" >Event Details</td>
														</tr>
														<tr>
															<td class="title">Event Price When Ordered</td>
															<td class="value">$1200.00</td>
														</tr>
														<tr>
															<td class="title">Current Event Price</td>
															<td class="value">$1200.00</td>
														</tr>
														<tr>
															<td class="title">Event Code <a href="#" tabindex="-1" rel="tooltip" class="hint" title="" data-original-title="A unique string (alphanumerc, no spaces) to identify the sku."><i class="icon-question-sign"></i></a></td>
															<td class="value">C-567YGH</td>
														</tr>
														<tr>
															<td class="title">Event Start Date/Time <a href="#" tabindex="-1" rel="tooltip" class="hint" title="" data-original-title="A unique string (alphanumerc, no spaces) to identify the sku."><i class="icon-question-sign"></i></a></td>
															<td class="value">9-12-2015 @ 7am</td>
														</tr>
														<tr>
															<td class="title">Event End Date/Time <a href="#" tabindex="-1" rel="tooltip" class="hint" title="" data-original-title="A unique string (alphanumerc, no spaces) to identify the sku."><i class="icon-question-sign"></i></a></td>
															<td class="value">9-12-2015 @ 9pm</td>
														</tr>
														<tr>
															<td class="title">Available To Sell <a href="#" tabindex="-1" rel="tooltip" class="hint" title="" data-original-title="A unique string (alphanumerc, no spaces) to identify the sku."><i class="icon-question-sign"></i></a></td>
															<td class="value">1000</td>
														</tr>
														<tr>
															<td class="title">Immediately Available To Sell <a href="#" tabindex="-1" rel="tooltip" class="hint" title="" data-original-title="A unique string (alphanumerc, no spaces) to identify the sku."><i class="icon-question-sign"></i></a></td>
															<td class="value">1000</td>
														</tr>
														<tr class="s-table-header">
					...
					<div class="s-content-object">
						<div class="col-md-2 s-content-header">
							<h4 class="s-content-title">Details</h4>
							<p class="s-content-description">Choose what details you would like for this product.</p>
						</div>
						<div class="col-md-10 s-content-body">
							
							<div class="s-content-well">
									
								<div class="col-sm-2 s-content-image">
									<img src="http://placehold.it/350x350" width="100%">
								</div>
												...
												<div class="form-group"><!-- Option select field wrapper -->
													...
													<div class="input-group">
														<div class="s-input-btn">
															<input id="searchinput" value="B" type="search" class="form-control">
					...
					<div class="s-content-object">
						<div class="col-md-2 s-content-header">
							...
							<p class="s-content-description">Choose a fullfilment method.</p>
						</div>
						<div class="col-md-10 s-content-body">
										...
										<div class="col-md-6 s-content-item">
											...
											<div class="table-responsive">
												<table class="table table-condensed s-info-table">
													<tbody>
														<tr class="s-table-header">
															<td colspan="2" class="table-section">Info</td>
														</tr>
														<tr>
															<td class="title">Address</td>
															<td class="value">
																789 Rogers Dr. Pine Springs, CA 83746
															</td>
														</tr>
													</tbody>
												</table>
