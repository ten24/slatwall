...
*/
component entityname="SlatwallUpdateScript" table="SwUpdateScript" persistent="true" accessors="true" output="true" extends="Slatwall.model.entity.HibachiEntity" hb_serviceName="updateService" hb_auditable="false" {
