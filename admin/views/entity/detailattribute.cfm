	...
	<cf_HibachiEntityDetailForm object="#rc.attribute#" edit="#rc.edit#" 
		...
		<cf_HibachiPropertyRow>
			<cf_HibachiPropertyList>
				...
				<cf_HibachiDisplayToggle selector="select[name='attributeInputType']" showValues="relatedObjectSelect,relatedObjectMultiselect" loadVisable="#(!isNull(rc.attribute.getAttributeType()) && listFindNoCase('relatedObjectSelect,releatedObjectMultiselect', rc.attribute.getAttributeType()))#">
