...
*/
component entityname="SlatwallStockReceiverItem" table="SwStockReceiverItem" persistent=true accessors=true output=false extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="stockService" {
