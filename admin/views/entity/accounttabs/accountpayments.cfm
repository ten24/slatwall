...
<cfoutput>
	...
	<cf_HibachiProcessCaller action="admin:entity.preprocessaccount" entity="#rc.account#" processContext="addAccountPayment" class="btn" icon="plus" modalFullWidth="true" />
</cfoutput>
