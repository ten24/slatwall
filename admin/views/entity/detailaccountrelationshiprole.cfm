...
<cfoutput>
	<hb:HibachiEntityDetailForm object="#rc.accountRelationshipRole#" edit="#rc.edit#">
		...
		<hb:HibachiEntityDetailGroup object="#rc.accountRelationshipRole#">
			<hb:HibachiEntityDetailItem view="admin:entity/accountRelationshipRoleTabs/basic" open="true" text="#$.slatwall.rbKey('admin.define.basic')#" />
