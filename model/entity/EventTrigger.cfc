...
*/
component entityname="SlatwallEventTrigger" table="SwEventTrigger" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="eventTriggerService" hb_permission="this" {
