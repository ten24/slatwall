...
*/
component entityname="SlatwallVendorSkuStock" table="SwVendorSkuStock" persistent=true accessors=true output=false extends="HibachiEntity" cacheuse="transactional" hb_serviceName="vendorService" {
