...
component extends="Slatwall.meta.tests.unit.SlatwallUnitTestBase" {
	...
	*/
	public void function test_creating_card(){
		...
		// getGiftCardCode autogenerates base on a sku setting so we need to mock sku entity and relevant methods
		var mockSku = createMock("Slatwall.model.entity.Sku");
		mockSku.$("getGiftCardAutoGenerateCodeFlag", true);
		mockSku.$("setting").$args("skuGiftCardCodeLength").$results(16);
		giftOrderItem.setSku(mockSku);
		...
		// Remove mockSku so it is not part of ormSession
		giftOrderItem.setSku(javacast("null", ""));
