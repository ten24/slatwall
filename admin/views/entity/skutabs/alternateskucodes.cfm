...
<cfoutput>
	...
	<cf_HibachiActionCaller action="admin:entity.createalternateskucode" class="btn btn-default" icon="plus" queryString="redirectAction=admin:entity.detailsku&skuID=#rc.sku.getSkuID()#" modal="true" />
</cfoutput>
