...
var MonatProductListingController = /** @class */ (function () {
    // @ngInject
    MonatProductListingController.$inject = ["$rootScope", "publicService", "observerService", "$timeout", "monatService", "monatAlertService", "orderTemplateService", "rbkeyService"];
    function MonatProductListingController($rootScope, publicService, observerService, $timeout, monatService, monatAlertService, orderTemplateService, rbkeyService) {
        var _this = this;
        this.$rootScope = $rootScope;
        this.publicService = publicService;
        this.observerService = observerService;
...
/******/ });
//# sourceMappingURL=monatFrontend.5695d823d42704fa1d71.bundle.js.map