  ...
  <body class="toolbar-enabled">
              ...
              <div class="col-lg-7 pr-lg-0">
                <div class="cz-product-gallery">
                  <div class="cz-preview order-sm-2">
                    <div class="cz-preview-item active" id="first"><img class="cz-image-zoom" src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/01.jpg" data-zoom="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/01.jpg" alt="Product image">
                      <div class="cz-image-zoom-pane"></div>
                    </div>
                    <div class="cz-preview-item" id="second"><img class="cz-image-zoom" src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/02.jpg" data-zoom="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/02.jpg" alt="Product image">
                      <div class="cz-image-zoom-pane"></div>
                    </div>
                    <div class="cz-preview-item" id="third"><img class="cz-image-zoom" src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/03.jpg" data-zoom="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/03.jpg" alt="Product image">
                      <div class="cz-image-zoom-pane"></div>
                    </div>
                    <div class="cz-preview-item" id="fourth"><img class="cz-image-zoom" src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/04.jpg" data-zoom="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/04.jpg" alt="Product image">
                      <div class="cz-image-zoom-pane"></div>
                    </div>
                  </div>
                  <div class="cz-thumblist order-sm-1"><a class="cz-thumblist-item active" href="##first"><img src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/th01.jpg" alt="Product thumb"></a><a class="cz-thumblist-item" href="##second"><img src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/th02.jpg" alt="Product thumb"></a><a class="cz-thumblist-item" href="##third"><img src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/th03.jpg" alt="Product thumb"></a><a class="cz-thumblist-item" href="##fourth"><img src="#$.getThemePath()#/custom/client/assets/images/shop/single/gallery/th04.jpg" alt="Product thumb"></a></div>
                </div>
              </div>
              <!-- Product details-->
                ...
                <div class="product-details ml-auto pb-3">
                  ...
                  <div class="position-relative mr-n4 mb-3">
                    <div class="custom-control custom-option custom-control-inline mb-2">
                      ...
                      <label class="custom-option-label rounded-circle" for="color1"><span class="custom-option-color rounded-circle" style="background-image: url(#$.getThemePath()#/custom/client/assets/images/shop/single/color-opt-1.png)"></span></label>
                    </div>
                    <div class="custom-control custom-option custom-control-inline mb-2">
                      <input class="custom-control-input" type="radio" name="color" id="color2">
                      <label class="custom-option-label rounded-circle" for="color2"><span class="custom-option-color rounded-circle" style="background-image: url(#$.getThemePath()#/custom/client/assets/images/shop/single/color-opt-2.png)"></span></label>
                    </div>
                    <div class="custom-control custom-option custom-control-inline mb-2">
                      <input class="custom-control-input" type="radio" name="color" id="color3">
                      <label class="custom-option-label rounded-circle" for="color3"><span class="custom-option-color rounded-circle" style="background-image: url(#$.getThemePath()#/custom/client/assets/images/shop/single/color-opt-3.png)"></span></label>
                    </div>
    ...
    <div class="navbar-sticky bg-light">
      <div class="navbar navbar-expand-lg navbar-light">
        <div class="container"><a class="navbar-brand d-none d-sm-block mr-3 flex-shrink-0" href="/" style="min-width: 7rem;"><img width="472" src="#$.getThemePath()#/custom/client/assets/images/sb-logo.png" alt="Stone & Berg Logo"/></a><a class="navbar-brand d-sm-none mr-2" href="/" style="min-width: 4.625rem;"><img width="134" src="#$.getThemePath()#/custom/client/assets/images/sb-logo-mobile.png" alt="Stone & Berg Logo"/></a>
          ...
          <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="##navbarCollapse"><span class="navbar-toggler-icon"></span></button><a class="navbar-tool navbar-stuck-toggler" href="##"><span class="navbar-tool-tooltip">Expand menu</span>
              <div class="navbar-tool-icon-box"><i class="far fa-user"></i></div></a><a class="navbar-tool ml-1 ml-lg-0 mr-n1 mr-lg-2" href="##signin-modal" data-toggle="modal">
              ...
              <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="##" data-toggle="dropdown">Home</a>
                <ul class="dropdown-menu">
                  <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom" href="home-fashion-store-v1.html"><span class="d-block text-heading">Fashion Store v.1</span><small class="d-block text-muted">Classic shop layout</small></a>
                    <div class="dropdown-menu h-100 animation-0 mt-0 p-3"><a class="d-block" href="home-fashion-store-v1.html" style="width: 250px;"><img src="#$.getThemePath()#/custom/client/assets/images/home/preview/th01.jpg" alt="Fashion Store v.1"/></a></div>
                  </li>
                  <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom" href="home-fashion-store-v2.html"><span class="d-block text-heading">Fashion Store v.2</span><small class="d-block text-muted">Slider + Featured categories</small></a>
                    <div class="dropdown-menu h-100 animation-0 mt-0 p-3"><a class="d-block" href="home-fashion-store-v2.html" style="width: 250px;"><img src="#$.getThemePath()#/custom/client/assets/images/home/preview/th02.jpg" alt="Fashion Store v.2"/></a></div>
                  </li>
                  <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom" href="home-electronics-store.html"><span class="d-block text-heading">Electronics Store</span><small class="d-block text-muted">Slider + Promo banners</small></a>
                    <div class="dropdown-menu h-100 animation-0 mt-0 p-3"><a class="d-block" href="home-electronics-store.html" style="width: 250px;"><img src="#$.getThemePath()#/custom/client/assets/images/home/preview/th03.jpg" alt="Electronics Store"/></a></div>
                  </li>
                  <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom" href="home-marketplace.html"><span class="d-block text-heading">Marketplace</span><small class="d-block text-muted">Multi-vendor, digital goods</small></a>
                    <div class="dropdown-menu h-100 animation-0 mt-0 p-3"><a class="d-block" href="home-marketplace.html" style="width: 250px;"><img src="#$.getThemePath()#/custom/client/assets/images/home/preview/th04.jpg" alt="Marketplace"/></a></div>
                  </li>
                  <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom" href="home-single-store.html"><span class="d-block text-heading">Single Product Store</span><small class="d-block text-muted">Single product / mono brand</small></a>
                    <div class="dropdown-menu h-100 animation-0 mt-0 p-3"><a class="d-block" href="home-single-store.html" style="width: 250px;"><img src="#$.getThemePath()#/custom/client/assets/images/home/preview/th05.jpg" alt="Single Product / Brand Store"/></a></div>
                  </li>
                  <li class="dropdown position-static mb-0"><a class="dropdown-item py-2" href="home-grocery-store.html"><span class="d-block text-heading">Grocery Store</span><small class="d-block text-muted">Full width + Side menu</small></a>
                    <div class="dropdown-menu h-100 animation-0 mt-0 p-3"><a class="d-block" href="home-grocery-store.html" style="width: 250px;"><img src="#$.getThemePath()#/custom/client/assets/images/home/preview/th06.jpg" alt="Grocery Store"/></a></div>
                  </li>
                </ul>
              </li>
                ...
                <div class="dropdown-menu p-0">
                  <div class="d-flex flex-wrap flex-md-nowrap px-2">
                    ...
                    <div class="mega-dropdown-column py-4 pr-3">
                      ...
                      </div><a class="d-block" href="##"><img src="#$.getThemePath()#/custom/client/assets/images/shop/menu-banner.jpg" alt="Promo banner"/></a>
                    </div>
                  </div>
                </div>
              </li>
