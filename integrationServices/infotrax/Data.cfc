...
component accessors='true' output='false' displayname='InfoTrax' extends='Slatwall.org.Hibachi.HibachiObject' {
	...
	public struct function validatePlacement(required struct DTSArguments){
		return postRequest('ICEDistributor.validatePlacement', arguments.DTSArguments, getSessionToken());
	}
