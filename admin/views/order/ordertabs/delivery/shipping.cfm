		...
		<table class="listing-grid stripe">
			...
			<cfloop array="#local.orderDelivery.getOrderDeliveryItems()#" index="local.thisOrderDeliveryItem">
				<tr>
					...
					<td>#lsCurrencyFormat(local.thisOrderDeliveryItem.getOrderItem().getPrice())#</td>
					<td>#local.thisOrderDeliveryItem.getQuantityDelivered()#</td>
					<td>#lsCurrencyFormat(local.thisOrderDeliveryItem.getOrderItem().getExtendedPrice())#</td>
				</tr>
			</cfloop>
		</table>
