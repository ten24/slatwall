...
<cfset selectedContent = rc.subscriptionUsageBenefit.getContents() />
...
<cfset selectedExcludedContent = rc.subscriptionUsageBenefit.getExcludedContents() />
...
<cfoutput>
	<div class="col-md-6">
		...
		<hb:HibachiListingDisplay smartList="#rc.subscriptionUsageBenefit.getContentsOptionsSmartList()#" multiselectFieldName="contents" multiselectValues="#selectedContentIDs#" edit="#rc.edit#">
	...
	<div class="col-md-6">
		...
		<hb:HibachiListingDisplay smartList="#rc.subscriptionUsageBenefit.getExcludedContentsOptionsSmartList()#" multiselectFieldName="excludedContents" multiselectValues="#selectedExcludedContentIDs#" edit="#rc.edit#">
			<hb:HibachiListingColumn propertyIdentifier="title" tdclass="primary" />
			<hb:HibachiListingColumn propertyIdentifier="site.siteName" />
		</hb:HibachiListingDisplay>	
	</div>
