...
var PromoModalController = /** @class */ (function () {
    //@ngInject
    PromoModalController.$inject = ["rbkeyService", "observerService", "publicService", "monatService", "ModalService", "monatAlertService"];
    function PromoModalController(rbkeyService, observerService, publicService, monatService, ModalService, monatAlertService) {
        var _this = this;
        this.rbkeyService = rbkeyService;
        this.observerService = observerService;
        this.publicService = publicService;
        ...
        this.ModalService = ModalService;
        this.monatAlertService = monatAlertService;
        this.selectPromotion = function (promotion) {
            if (!promotion.title) {
        ...
        this.viewSelectedPromotion = function () {
            _this.loading = true;
...
/******/ });
//# sourceMappingURL=monatFrontend.8d90b4592e3930914cfd.bundle.js.map