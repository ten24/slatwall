...
<cfoutput>
	<hb:HibachiEntityDetailForm object="#rc.account#" edit="#rc.edit#">
		<hb:HibachiEntityActionBar type="detail" object="#rc.account#" edit="#rc.edit#">
			...
			<li class="divider"></li>
			<hb:HibachiProcessCaller entity="#rc.account#" action="admin:entity.preprocessaccount" processContext="applyReferAFriendGiftCard" queryString="sRedirectAction=admin:entity.detailAccount" type="list" modal="true" hideDisabled="false" />
