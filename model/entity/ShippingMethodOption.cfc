...
*/
component entityname="SlatwallShippingMethodOption" table="SwShippingMethodOption" persistent=true accessors=true output=false extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="shippingService" {
