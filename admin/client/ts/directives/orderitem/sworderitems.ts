			...
			link: function(scope, element, attrs){
				...
				scope.getCollection = function(){
					...
					orderItemCollection.setDisplayProperties(
						'orderItemID,currencyCode,orderItemType,price,sku.skuName,skuPrice,sku.skuID,sku.skuCode,productBundleGroup.productBundleGroupID,sku.product.productID,'+
						...
						//'sku.subscriptionTerm.subscriptionTermName,sku.subscriptionBenefits,'+
						//'orderFulfillment.fulfillmentMethod.fulfillmentMethodType,orderFulfillment.pickupLocation.primaryAddress.address,sku.imageFile'
					)
