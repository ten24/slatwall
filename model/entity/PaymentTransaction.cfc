...
*/
component entityname="SlatwallPaymentTransaction" table="SwPaymentTransaction" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="paymentService" {
