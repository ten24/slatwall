...
*/
component displayname="Currency" entityname="SlatwallCurrency" table="SwCurrency" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="currencyService" hb_permission="this" hb_defaultOrderProperty="currencyName" {
