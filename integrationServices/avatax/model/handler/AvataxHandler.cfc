...
component {
	...
	public void function afterOrderProcess_PlaceOrderSuccess(required any slatwallScope, required any order) {
		...
		//arguments.slatwallScope.getService('integrationService').getIntegrationByIntegrationPackage('avatax').getIntegrationCFC('tax').postOrderInvoice(arguments.order);
	}
