...
*/
component displayname="Location Address" entityname="SlatwallLocationAddress" table="SwLocationAddress" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="locationService" hb_permission="location.locationAddresses" {
