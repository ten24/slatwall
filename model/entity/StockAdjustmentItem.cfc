...
*/
component entityname="SlatwallStockAdjustmentItem" table="SwStockAdjustmentItem" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="stockService" hb_permission="stockAdjustment.stockAdjustmentItems" {
