...
*/
component displayname="Inventory" entityname="SlatwallInventory" table="SwInventory" persistent=true accessors=true output=false extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="inventoryService" {
