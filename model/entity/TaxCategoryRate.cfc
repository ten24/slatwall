...
*/
component entityname="SlatwallTaxCategoryRate" table="SwTaxCategoryRate" persistent="true" output="false" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="taxService" hb_permission="taxCategory.taxCategoryRates" {
