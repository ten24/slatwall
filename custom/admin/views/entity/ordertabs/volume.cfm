...
<cfoutput>
	<table class="table table-bordered">
		...
		<tr>	
			<td><hb:HibachiPropertyDisplay object="#rc.order#" property="taxableAmountSubtotal" edit="false" /></td>
			<td><hb:HibachiPropertyDisplay object="#rc.order#" property="taxableAmountSubtotalAfterItemDiscounts" edit="false"/></td>
			<td><hb:HibachiPropertyDisplay object="#rc.order#" property="taxableAmountTotal" edit="false" /></td>
		</tr>
			
		<tr>
			<td><hb:HibachiPropertyDisplay object="#rc.order#" property="commissionableVolumeSubtotal" edit="false" /></td>
			
			<td><hb:HibachiPropertyDisplay object="#rc.order#" property="commissionableVolumeSubtotalAfterItemDiscounts" edit="false"/></td>
			<td><hb:HibachiPropertyDisplay object="#rc.order#" property="commissionableVolumeTotal" edit="false"/></td>
		</tr>
