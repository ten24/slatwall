    ...
    <article>
    	<div>
    	    ...
    	    <cfif NOT isNull(order.getModifiedDateTime())>
    			<p>Last updated on: #DateTimeFormat(order.getModifiedDateTime(), "mmmm dd, yyyy 'at' hh:nn tt")#</p>
    		</cfif>
    	</div>
        <div class="row">
            <div class="col-lg-9 col-md-12">
    		    ...
    		    <div class="row">
    			    <!--- Shipping --->
        			<div class="col-6 bg-light border-right border-white">
        			...
        			<!--- Billing & Payment --->
        			<div class="col-6 bg-light border-left border-white ">
