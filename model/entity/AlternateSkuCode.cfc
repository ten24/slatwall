...
*/
component displayname="Alternate Sku Code" entityname="SlatwallAlternateSkuCode" table="SwAlternateSkuCode" persistent=true accessors=true output=false extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="skuService" {
