...
component extends="HibachiService" output="false" accessors="true" {
	...
	public struct function getAllSettingMetaData() {
		var allSettingMetaData = {
			...
			globalClientSecret = {fieldtype="text",defaultValue="SlatwallSecret"},
			...
			skuDefaultImageNamingConvention = {fieldType="text", defaultValue="${product.productCode} ${allOptionCodes}"},
			...
			skuGiftCardCodeLength = {fieldType="text", defaultValue=32},
