...
component accessors="true" output="false" extends="Slatwall.model.transient.HibachiTransient" {
	...
	property name="orderItem" type="any";
	property name="orderItemQuantity" type="numeric";
	property name="sku" type="any";
	...
	public any function getSku() {
	    if(!structKeyExists(variables, 'sku') || isNull(variables.sku)){
		    return getOrderItem().getSku();
	    }
	    return variables.sku;
	}
	
	public any function getCurrencyCode(){
		return getOrderItem().getCurrencyCode();
	}
}
