...
/***/ function(module, exports, __webpack_require__) {
	...
	var logger_module_1 = __webpack_require__(119);
	//custom bootstrapper
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slatwallinterceptor_1 = __webpack_require__(113);
	var ngslatwall_module_1 = __webpack_require__(114);
	var ngslatwallmodel_module_1 = __webpack_require__(116);
	//filters
	var entityrbkey_1 = __webpack_require__(117);
	var swcurrency_1 = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var otherwisecontroller_1 = __webpack_require__(23);
	var routercontroller_1 = __webpack_require__(24);
	//filters
	...
	//  entity
	var swdetail_1 = __webpack_require__(50);
	var swlist_1 = __webpack_require__(51);
	//  validation
	var swvalidate_1 = __webpack_require__(52);
	var swvalidationminlength_1 = __webpack_require__(53);
	var swvalidationdatatype_1 = __webpack_require__(54);
	var swvalidationeq_1 = __webpack_require__(55);
...
/***/ function(module, exports) {
	...
	var SWActionCallerController = (function () {
	    ...
	    function SWActionCallerController($scope, $element, $templateRequest, $compile, corePartialsPath, utilityService, $slatwall, pathBuilderConfig) {
	        ...
	        this.$slatwall = $slatwall;
	        this.utilityService = utilityService;
	        this.$templateRequest(pathBuilderConfig.buildPartialsPath(corePartialsPath) + "actioncaller.html").then(function (html) {
	    ...
	    function SWExpandableRecord($compile, $templateRequest, $timeout, corePartialsPath, utilityService, pathBuilderConfig) {
	        ...
	        this.link = function (scope, element, attrs) {
	            if (scope.swExpandableRecord.expandable && scope.swExpandableRecord.childCount) {
	                ...
	                _this.$templateRequest(_this.pathBuilderConfig(_this.corePartialsPath) + "expandablerecord.html").then(function (html) {
	                    var template = angular.element(html);
...
/***/ function(module, exports) {
	...
	var SWListingDisplayController = (function () {
	    function SWListingDisplayController($scope, $element, $transclude, $timeout, $q, $slatwall, corePartialsPath, utilityService, collectionConfigService, paginationService, selectionService, observerService) {
	        var _this = this;
	        this.$scope = $scope;
	        this.$element = $element;
	    ...
	    SWListingDisplayController.$inject = ['$scope', '$element', '$transclude', '$timeout', '$q', '$slatwall', 'corePartialsPath', 'utilityService', 'collectionConfigService', 'paginationService', 'selectionService', 'observerService'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/// <reference path="../../../typings/slatwallTypeScript.d.ts" />
	//services
	var paginationservice_1 = __webpack_require__(57);
	var swpaginationbar_1 = __webpack_require__(58);
	var core_module_1 = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/// <reference path='../../../typings/tsd.d.ts' />
	//services
	var dialogservice_1 = __webpack_require__(60);
	//controllers
	var pagedialog_1 = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_module_1 = __webpack_require__(15);
	//controllers
	var preprocessorderitem_addorderitemgiftrecipient_1 = __webpack_require__(63);
	//directives
	var swaddorderitemgiftrecipient_1 = __webpack_require__(65);
	var swgiftcardbalance_1 = __webpack_require__(66);
	var swgiftcarddetail_1 = __webpack_require__(67);
	var swgiftcardhistory_1 = __webpack_require__(68);
	var swgiftcardoverview_1 = __webpack_require__(69);
	var swgiftcardorderinfo_1 = __webpack_require__(70);
	var swgiftcardrecipientinfo_1 = __webpack_require__(71);
	var sworderitemgiftrecipientrow_1 = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/// <reference path='../../../../typings/slatwallTypescript.d.ts' />
	/// <reference path='../../../../typings/tsd.d.ts' />
	var giftrecipient_1 = __webpack_require__(64);
	var OrderItemGiftRecipientControl = (function () {
	    ...
	    function OrderItemGiftRecipientControl($scope, $slatwall) {
	        ...
	        this.updateResults = function (keyword) {
	            ...
	            var accountPromise = _this.$slatwall.getEntity('account', options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_module_1 = __webpack_require__(15);
	//services
	var collectionconfigservice_1 = __webpack_require__(74);
	var collectionservice_1 = __webpack_require__(75);
	//controllers
	var collections_1 = __webpack_require__(76);
	var createcollection_1 = __webpack_require__(77);
	var confirmationcontroller_1 = __webpack_require__(78);
	//directives
	var swcollection_1 = __webpack_require__(79);
	var swaddfilterbuttons_1 = __webpack_require__(80);
	var swdisplayoptions_1 = __webpack_require__(81);
	var swdisplayitem_1 = __webpack_require__(82);
	var swcollectiontable_1 = __webpack_require__(83);
	var swcolumnitem_1 = __webpack_require__(84);
	var swconditioncriteria_1 = __webpack_require__(85);
	var swcriteria_1 = __webpack_require__(86);
	var swcriteriaboolean_1 = __webpack_require__(87);
	var swcriteriamanytomany_1 = __webpack_require__(88);
	var swcriteriamanytoone_1 = __webpack_require__(89);
	var swcriterianumber_1 = __webpack_require__(90);
	var swcriteriaonetomany_1 = __webpack_require__(91);
	var swcriteriastring_1 = __webpack_require__(92);
	var sweditfilteritem_1 = __webpack_require__(93);
	var swfiltergroups_1 = __webpack_require__(94);
	var swfilteritem_1 = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/// <reference path='../../../typings/tsd.d.ts' />
	//services
	var workflowconditionservice_1 = __webpack_require__(97);
	//directives
	var swadmincreatesuperuser_1 = __webpack_require__(98);
	var swworkflowbasic_1 = __webpack_require__(99);
	var swworkflowcondition_1 = __webpack_require__(100);
	var swworkflowconditiongroupitem_1 = __webpack_require__(101);
	var swworkflowconditiongroups_1 = __webpack_require__(102);
	var swworkflowtask_1 = __webpack_require__(103);
	var swworkflowtaskactions_1 = __webpack_require__(104);
	var swworkflowtasks_1 = __webpack_require__(105);
	var swworkflowtrigger_1 = __webpack_require__(106);
	var swworkflowtriggers_1 = __webpack_require__(107);
	//filters
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_module_1 = __webpack_require__(15);
	//services
	var productbundleservice_1 = __webpack_require__(109);
	//controllers
	var create_bundle_controller_1 = __webpack_require__(126);
	//directives
	var swproductbundlegrouptype_1 = __webpack_require__(110);
	var swproductbundlegroups_1 = __webpack_require__(111);
	var swproductbundlegroup_1 = __webpack_require__(112);
	//filters
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slatwallservice_1 = __webpack_require__(115);
