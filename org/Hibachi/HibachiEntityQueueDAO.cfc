...
component extends="HibachiDAO" persistent="false" accessors="true" output="false" {
	...
	public void function insertEntityQueue(required string baseID, required string baseObject, string processMethod='', string entityQueueID = createHibachiUUID(), entityQueueType='', entityType=''){
