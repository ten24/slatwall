...
var MonatService = /** @class */ (function () {
    ...
    **/
    ...
    MonatService.prototype.getPromotionRewardSkus = function (promotionRewardID) {
        var _this = this;
        var deferred = this.$q.defer();
        if (this.promotionRewardSkus[promotionRewardID]) {
            ...
            this.publicService.doAction('getQualifiedPromotionRewardSkusForOrder', data).then(function (result) {
...
/******/ });
//# sourceMappingURL=monatFrontend.a4e2f7dcedabad74c14b.bundle.js.map