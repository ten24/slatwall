...
module.exports = "\t<div ng-cloak class=\"card mb-3 w-100\">\n\t\t<div class=\"card-header bg-transparent p-0\">\n\t\t\t<div class=\"bg-primary\">\n\t\t\t\t<a ng-click=\"enrollmentFlexship.refreshFlexship()\" ng-class=\"{'collapsed': (enrollmentFlexship.type != 'vipFlexshipFlow' && !enrollmentFlexship.expandFlexship) }\" class=\"py-0\" data-toggle=\"collapse\" href=\"#flexshipBody\">\n\t\t\t\t\t<div class=\"py-3 px-3 text-white\">\n\t\t\t\t\t\t<span sw-rbKey=\"'frontend.hybridCart.yourFlexship'\"></span> \n\t\t\t\t\t\t<span \n\t\t\t\t\t\t\tng-if=\"!enrollmentFlexship.isLoading\" \n\t\t\t\t\t\t\tng-bind-html=\" ' - ' + enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.calculatedTotal ? enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.calculatedTotal - enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.purchasePlusTotal : 0 | swcurrency:enrollmentFlexship.hybridCart.cart.currencyCode\"\n\t\t\t\t\t\t></span>\n\t\t\t\t\t\n\t\t\t\t\t\t<i class=\"fas fa-chevron-down\"></i>\n\t\t\t\t\t</div>\t\t\t\t\t\n\t\t\t\t</a>\n\t\t\t</div>\n\t\t</div>\n\t\t<div ng-class=\"{'collapse': (enrollmentFlexship.type != 'vipFlexshipFlow' && !enrollmentFlexship.expandFlexship), 'collapse show': (enrollmentFlexship.type == 'vipFlexshipFlow' || enrollmentFlexship.expandFlexship) }\" class=\"multi-collapse\" data-parent=\"#accordion\" id=\"flexshipBody\">\n\t\t\t<div class=\"cart-progress-bar\">\n\t\t\t\t<flexship-purchase-plus messages=\"enrollmentFlexship.messages\"></flexship-purchase-plus>\n\t\t\t</div>\n\t\t\t<div class=\"card-body p-0 hybrid-cart-body\">\n\t\t\t\t<ul class=\"list-group list-group-flush\">\n\t\t\t\t\t<li ng-repeat=\"item in enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.orderTemplateItems\" class=\"bg-transparent list-group-item d-flex justify-content-between align-items-center\">\n\t\t\t\t\t\t<div class=\"row align-items-center\">\n\t\t\t\t\t\t\t<div class=\"cart-img\">\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<img \n\t\t\t\t\t\t\t\t\timage-manager \n\t\t\t\t\t\t\t\t\theight=\"75px\" \n\t\t\t\t\t\t\t\t\twidth=\"auto\"\n\t\t\t\t\t\t\t\t\tng-src=\"{{item.sku_imagePath}}\" \n\t\t\t\t\t\t\t\t\talt=\"{{item.sku_product_productName}}\"\n\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"col\">\n\t\t\t\t\t\t\t\t<a class=\"w-100 pb-1 pt-0\" ng-href=\"{{item.skuProductURL}}\">\n\t\t\t\t\t\t\t\t\t<p class=\"title\" ng-bind=\"item.sku_product_productName\"></p>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t<div class=\"qty\">\n\t\t\t\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t\t\t\t<button\n\t\t\t\t\t\t\t\t\t\t\ttype=\"button\"\n\t\t\t\t\t\t\t\t\t\t\tclass=\"minus p-0\"\n\t\t\t\t\t\t\t\t\t\t\tng-disabled=\"item.quantity <= 1\"\n\t\t\t\t\t\t\t\t\t\t\tng-click=\"enrollmentFlexship.decreaseOrderTemplateItemQuantity(item)\"\n\t\t\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\t\t\t\t- \n\t\t\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t\t\t\t<input\n\t\t\t\t\t\t\t\t\t\t\ttype=\"text\"\n\t\t\t\t\t\t\t\t\t\t\tid=\"qty\"\n\t\t\t\t\t\t\t\t\t\t\tname=\"quantity\"\n\t\t\t\t\t\t\t\t\t\t\tng-model=\"item.quantity\"\n\t\t\t\t\t\t\t\t\t\t/>\n\t\t\t\t\t\t\t\t\t\t<button\n\t\t\t\t\t\t\t\t\t\t\ttype=\"button\"\n\t\t\t\t\t\t\t\t\t\t\tclass=\"plus p-0\"\n\t\t\t\t\t\t\t\t\t\t\tng-click=\"enrollmentFlexship.increaseOrderTemplateItemQuantity(item)\"\n\t\t\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\t\t\t\t+\n\t\t\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t\t\t<span class=\"ml-2 text-right\" ng-bind-html=\"item.calculatedTotal | swcurrency:enrollmentFlexship.hybridCart.cart.currencyCode\"></span>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<span class=\"badge badge-pill delete\">\n\t\t\t\t\t\t\t<a ng-click=\"enrollmentFlexship.removeOrderTemplateItem(item)\" href=\"#\">\n\t\t\t\t\t\t\t\t<i class=\"fal fa-times\"></i>\n\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t</span>\n\t\t\t\t\t</li>\n\t\t\t\t</ul>\t\t\t\t\t\t\t\n\t\t\t</div>\n\t\t\t<div class=\"card-footer\">\n\t\t\t\t<div ng-if=\"enrollmentFlexship.cartThreshold && enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.calculatedSubTotal < enrollmentFlexship.cartThreshold\" class=\"flexship-alert px-3 py-2\">\n\t\t\t\t\t<i class=\"fal fa-exclamation-circle text-danger\"></i>\n\t\t\t\t\t<p class=\"my-1\">\n\t\t\t\t\t\t<span sw-rbkey=\"'frontend.flexshipCartContainer.alertOFYAndFreeShippingP1'\"></span>\n\t\t\t\t\t\t<span ng-bind-html=\"enrollmentFlexship.cartThreshold | swcurrency:enrollmentFlexship.hybridCart.cart.currencyCode\"></span> \n\t\t\t\t\t\t<span sw-rbkey=\"'frontend.enrollmentFlexship.toQualify'\"></span>\n\t\t\t\t\t</p>\n\t\t\t\t</div>\n\t\t\t\t<div ng-if=\"enrollmentFlexship.suggestedRetailPrice > 0\" class=\"row justify-content-between suggested\">\n\t\t\t\t\t<span sw-rbKey=\"'frontend.hybridCart.suggestedPrice'\"></span>\n\t\t\t\t\t<span ng-bind-html=\"enrollmentFlexship.suggestedRetailPrice | swcurrency:enrollmentFlexship.hybridCart.cart.currencyCode\"></span>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"summary\">\n\t\t\t\t\t<div class=\"row justify-content-between\">\n\t\t\t\t\t\t<span sw-rbKey=\"'frontend.hybridCart.yourPrice'\"></span>\n\t\t\t\t\t\t<span ng-bind-html=\"(enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.calculatedSubTotal ? enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.calculatedSubTotal : 0 )| swcurrency:enrollmentFlexship.hybridCart.cart.currencyCode\"></span>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"row justify-content-between\">\n\t\t\t\t\t\t<span sw-rbKey=\"'frontend.hybridCart.purchasePlus'\"></span>\n\t\t\t\t\t\t<span ng-bind-html=\"(enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.purchasePlusTotal ? enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.purchasePlusTotal : 0) | swcurrency:enrollmentFlexship.hybridCart.cart.currencyCode\"></span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"row justify-content-between total\">\n\t\t\t\t\t<span sw-rbKey=\"'frontend.hybridCart.yourFlexship'\"></span>\n\t\t\t\t\t<span ng-bind-html=\"(enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.calculatedTotal ? enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.calculatedTotal - enrollmentFlexship.orderTemplateService.mostRecentOrderTemplate.purchasePlusTotal : 0) | swcurrency:enrollmentFlexship.hybridCart.cart.currencyCode\"></span>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\t\n\n";
...
module.exports = "<nav ng-if=\"paginationController.displayPagination\" class=\"product-pagination\" >\n\t<ul class=\"pagination justify-content-center\">\n\t    \n\t\t<!-- Back 1 Page --->\n\t\t<li class=\"page-item\" ng-class=\"{'disabled': paginationController.pageTracker == 1}\">\n\t\t\t<button ng-click=\"paginationController.paginate(1,'prev')\" class=\"page-link\" tabindex=\"-1\" aria-disabled=\"true\">\n\t\t\t\t<i class=\"fas fa-chevron-left\"></i>\n\t\t\t</button>\n\t\t</li>\n\t\t\n\t\t<!-- Go to specific page --->\n\t\t<li class=\"page-item\" ng-class=\"{active: this.number == paginationController.pageTracker}\" ng-repeat=\"number in paginationController.displayPages | limitTo: paginationController.elipsesNum\" >\n\t\t\t<button class=\"page-link\" ng-click=\"paginationController.paginate(number)\">{{number}}</button>\n\t\t</li>\n\t\t\n        <!--- Ellipsis to get next group of pages if total pages is greater than 10 --->\n        <li class=\"page-item\" ng-show=\"paginationController.displayPages.length > paginationController.elipsesNum && paginationController.hasNextPageSet\" >\n            <button class=\"page-link\" ng-click=\"paginationController.paginate(1, false, true)\">...</button>\n        </li>\n        \n\t\t<!-- Forward 1 Page --->\n\t\t<li class=\"page-item\" ng-class=\"{'disabled': !paginationController.hasNextPageSet }\">\n\t\t\t<button ng-click=\"paginationController.paginate(1, 'next')\" class=\"page-link\">\n\t\t\t\t<i class=\"fas fa-chevron-right\"></i>\n\t\t\t</button>\t\t\t\t\n\t\t</li>\n\t\t\n\t</ul> \n</nav>";
...
var UpgradeMPController = /** @class */ (function () {
    ...
    function UpgradeMPController(publicService, observerService, monatService) {
        ...
        this.getProductList = function (pageNumber, pageRecordsShow) {
            ...
            _this.loading = true;
            _this.publicService.doAction('getproductsByCategoryOrContentID', { priceGroupCode: 1 }, 'GET').then(function (result) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MonatFilterMenu = void 0;
var MonatFilterMenuController = /** @class */ (function () {
    function MonatFilterMenuController(monatService) {
        var _this = this;
        this.monatService = monatService;
        this.showFilterMenu = false;
        this.showMainFilterMenu = true;
        this.filterCategory = "";
        this.filterSubCategory = "";
        this.productFilterTitle = "";
        this.$onInit = function () {
            _this.productFunction = _this.productFunction || 'getProductList';
        };
        this.toggleFilterMenu = function () {
            _this.setTopHeight();
            _this.showFilterMenu = !_this.showFilterMenu;
        };
        this.toggleFilterSubCategory = function (category) {
            _this.showMainFilterMenu = false;
            _this.filterCategory = category;
        };
        this.callProductFunction = function (category, categoryType) {
            return _this.parentController[_this.productFunction](category, categoryType);
        };
        this.clearFilter = function () {
            $('input[type="radio"]').prop('checked', false);
        };
        this.setTopHeight = function () {
            _this.headerHeight = $('.site-header').outerHeight();
        };
    }
    ;
    return MonatFilterMenuController;
}());
var MonatFilterMenu = /** @class */ (function () {
    function MonatFilterMenu() {
        this.restrict = 'E';
        this.scope = {};
        this.bindToController = {
            parentController: '=',
        ...
        this.controller = MonatFilterMenuController;
        this.controllerAs = 'monatFilterMenu';
        this.template = __webpack_require__("jp19");
    }
    MonatFilterMenu.Factory = function () {
        var _this = this;
        return function () { return new _this(); };
    };
    return MonatFilterMenu;
}());
exports.MonatFilterMenu = MonatFilterMenu;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SaveEnrollmentModal = void 0;
var SaveEnrollmentModalController = /** @class */ (function () {
    //@ngInject
    SaveEnrollmentModalController.$inject = ["rbkeyService", "observerService", "publicService", "monatAlertService"];
    function SaveEnrollmentModalController(rbkeyService, observerService, publicService, monatAlertService) {
        var _this = this;
        this.rbkeyService = rbkeyService;
        this.observerService = observerService;
        this.publicService = publicService;
        ...
        this.saveEnrollment = function () {
            ...
            return _this.publicService.doAction('saveEnrollment', data)
                .then(function (result) {
                if (result.errors) {
                    ...
                    for (var _i = 0, _a = result.messages; _i < _a.length; _i++) {
                        var message = _a[_i];
                        _this.monatAlertService.success(message);
                    }
                }
                _this.loading = false;
            });
    ...
    return SaveEnrollmentModalController;
}());
var SaveEnrollmentModal = /** @class */ (function () {
    function SaveEnrollmentModal() {
        this.restrict = 'E';
        this.scope = {};
        this.bindToController = {
            close: '=' //injected by angularModalService
        };
        this.controller = SaveEnrollmentModalController;
        this.controllerAs = "saveEnrollmentModal";
        this.template = __webpack_require__("sRZw");
        this.link = function (scope, element, attrs) {
        };
    }
    SaveEnrollmentModal.Factory = function () {
        var _this = this;
        return function () { return new _this(); };
    };
    return SaveEnrollmentModal;
}());
exports.SaveEnrollmentModal = SaveEnrollmentModal;
...
var VIPController = /** @class */ (function () {
    ...
    function VIPController(monatService, publicService, observerService, orderTemplateService) {
        ...
        this.getMpResults = function (model) {
            _this.publicService['marketPartnerResults'] = _this.publicService.doAction('getmarketpartners', {
        ...
        this.getFlexshipProductList = function (category, categoryType) {
            ...
            if (category) {
                ...
                for (var key in _this.flexshipProductFilters) {
                    _this.flexshipProductFilters[key] = null;
                }
                _this.flexshipProductFilters[categoryType] = category;
                _this.paginationObject['categoryID'] = category.value;
            }
            _this.publicService.doAction('getProductsByCategoryOrContentID', data, 'GET').then(function (result) {
                _this.observerService.notify("PromiseComplete");
        ...
        this.toggleShowFilterCategory = function (categoryName) {
            for (var _i = 0, _a = _this.monatService.productFilterCategories; _i < _a.length; _i++) {
                var category = _a[_i];
                if (category != categoryName) {
                    _this.showProductFilter[category] = false;
                }
            }
            _this.showProductFilter[categoryName] = !_this.showProductFilter[categoryName];
        };
        this.getProductList = function (category, categoryType) {
            ...
            if (category) {
                data.categoryFilterFlag = true;
                data.categoryID = category.value;
                for (var key in _this.productFilters) {
                    _this.productFilters[key] = null;
                }
                _this.productFilters[categoryType] = category;
                _this.paginationObject['categoryID'] = category.value;
            }
            _this.publicService.doAction('getproductsByCategoryOrContentID', data, 'GET').then(function (result) {
                _this.observerService.notify("PromiseComplete");
...
var SWFReviewListingController = /** @class */ (function () {
    ...
    function SWFReviewListingController($hibachi, $scope, requestService) {
        ...
        this.updatePageRecords = function (data) {
            ...
            var productReviewRequest = _this.requestService.newPublicRequest('getProductReviews', data, 'GET');
...
var MonatService = /** @class */ (function () {
    //@ngInject
    MonatService.$inject = ["$q", "$window", "publicService", "requestService", "observerService", "utilityService", "localStorageCache", "ModalService", "$timeout"];
    function MonatService($q, $window, publicService, requestService, observerService, utilityService, localStorageCache, ModalService, $timeout) {
        var _this = this;
        this.$q = $q;
        this.$window = $window;
        this.publicService = publicService;
        ...
        this.hasOwnerAccountOnSession = false;
        this.successfulActions = [];
        this.showAddToCartMessage = false;
        this.muraContent = {};
        this.productFilters = {};
        this.totalItemQuantityAfterDiscount = 0;
        this.qualifiedPromos = [];
        this.promotionRewardSkus = {};
        this.productFilterCategories = ['Hair', 'Skin', 'Wellness', 'Promotion'];
        ...
        this.getPromotionRewardSkus = function (promotionRewardID) {
            var deferred = _this.$q.defer();
            if (_this.promotionRewardSkus[promotionRewardID]) {
                deferred.resolve(_this.promotionRewardSkus[promotionRewardID]);
            }
            else {
                var data = {
                ...
                _this.publicService.doAction('getQualifiedPromotionRewardSkusForOrder', data).then(function (result) {
                    if (result.rewardSkus) {
                        _this.promotionRewardSkus[promotionRewardID] = result.rewardSkus;
    ...
    MonatService.prototype.getCart = function (refresh, param) {
        ...
        if (refresh || !cachedCart) {
            ...
            if (this.cart && this.cart.orderID && this.cart.orderID != ((_a = this.publicService.cart) === null || _a === void 0 ? void 0 : _a.orderID)) {
    ...
    MonatService.prototype.addMultipleToCart = function (data) {
    ...
    **/
    ...
    MonatService.prototype.updateCartPropertiesOnService = function (data) {
        ...
        this.totalItemQuantityAfterDiscount = 0;
        var lastRequest = this.publicService.requests;
        for (var _i = 0, _c = this.cart.orderItems; _i < _c.length; _i++) {
            var item = _c[_i];
        ...
        if (this.cartUpdated && ((_a = this.cart['purchasePlusMessage']) === null || _a === void 0 ? void 0 : _a.message) && this.currentCartDateTime != this.cart.modifiedDateTime) {
            this.timeOutThisProperty('showPurchasePlusMessage', 6);
        }
        if (this.cartUpdated && ((_b = this.cart['canPlaceOrderMessage']) === null || _b === void 0 ? void 0 : _b.message) && this.currentCartDateTime != this.cart.modifiedDateTime) {
    ...
    MonatService.prototype.timeOutThisProperty = function (thisKey, s, firstVal, lastVal) {
        var _this = this;
        if (firstVal === void 0) { firstVal = true; }
        if (lastVal === void 0) { lastVal = false; }
    ...
    MonatService.prototype.getProductFilters = function () {
        ...
        return this.publicService
            ...
            if (response.categories) {
                _this.productFilters = response.categories;
            }
            return _this.productFilters;
        });
    };
...
(function (Screen) {
    ...
    Screen[Screen["SHIPPING_METHOD"] = 3] = "SHIPPING_METHOD";
    Screen[Screen["PAYMENT"] = 4] = "PAYMENT";
    Screen[Screen["SPONSOR"] = 5] = "SPONSOR";
    Screen[Screen["REVIEW"] = 6] = "REVIEW";
})(Screen || (Screen = {}));
var StepState = /** @class */ (function () {
    ...
    Object.defineProperty(StepState.prototype, "isActive", {
        get: function () {
            return this.active;
        },
        set: function (val) {
...
var CheckoutState = /** @class */ (function () {
    function CheckoutState(cartPointer) {
        this.shipping = new StepState();
        this.shippingMethod = new StepState();
        this.payment = new StepState();
        this.review = new StepState();
        this.sponsor = new StepState();
        this._currentStep = Screen.ACCOUNT;
        this.shouldToggle = true;
        this.cart = cartPointer;
    }
    Object.defineProperty(CheckoutState.prototype, "currentStep", {
        get: function () {
            return this._currentStep;
        },
        set: function (val) {
            var strings = ['edit', 'account', 'shipping', 'shippingMethod', 'payment', 'sponsor', 'review'];
            var key = strings[val];
            if (val > this.maximumStep || !this[key])
                return;
            ...
            for (var _i = 0, strings_1 = strings; _i < strings_1.length; _i++) {
                var val_1 = strings_1[_i];
                if (val_1 == key || !this[val_1])
                    continue;
                this[val_1].isActive = false;
            }
...
var MonatCheckoutController = /** @class */ (function () {
    ...
    function MonatCheckoutController(publicService, observerService, $rootScope, $scope, ModalService, monatAlertService, monatService) {
        ...
        this.formHasBeenPosted = false;
        this.$onInit = function () {
            _this.state = new CheckoutState(_this.publicService.cart);
            ...
            _this.observerService.attach(function () {
                _this.getCurrentCheckoutScreen(false, false, false, Screen.SHIPPING_METHOD);
            ...
            _this.observerService.attach(function (data) {
                _this.state.cart = data;
            }, 'updatedCart');
            ...
            _this.$scope.slatwall.preValidate = _this.preValidate;
            do {
                _this.yearOptions.push(manipulateableYear++);
            } while (_this.yearOptions.length <= 9);
            _this.handleAccountResponse({ account: _this.publicService.account });
        };
        this.getCurrentCheckoutScreen = function (setDefault, hardRefresh, next, screenOverride) {
            if (setDefault === void 0) { setDefault = false; }
            if (hardRefresh === void 0) { hardRefresh = false; }
            if (next === void 0) { next = false; }
            return _this.monatService.getCart(hardRefresh).then(function (cart) {
                var _a, _b, _c, _d;
                _this.state.cart = cart;
                var screen = Screen.ACCOUNT;
                _this.calculateListPrice();
                if (((_a = _this.state.cart.orderPayments) === null || _a === void 0 ? void 0 : _a.length) && _this.state.cart.orderPayments[_this.state.cart.orderPayments.length - 1].accountPaymentMethod) {
                    _this.currentPaymentMethodID = (_b = _this.state.cart.orderPayments[_this.state.cart.orderPayments.length - 1].accountPaymentMethod) === null || _b === void 0 ? void 0 : _b.accountPaymentMethodID;
                }
                if (((_c = _this.state.cart.orderFulfillments) === null || _c === void 0 ? void 0 : _c.length) && ((_d = _this.state.cart.orderFulfillments[0].shippingAddress.addressID) === null || _d === void 0 ? void 0 : _d.length)) {
                    _this.currentShippingAddress = _this.state.cart.orderFulfillments[0].shippingAddress;
                }
                else {
                    _this.currentShippingAddress = null;
                }
                ...
                var reqList = _this.state.cart.orderRequirementsList;
                if (screenOverride) {
                    screen = screenOverride;
                }
                else if (!reqList.length && next && !_this.hasSponsor) {
                ...
                else if (reqList.indexOf('account') === -1 && _this.currentShippingAddress) {
                ...
                _this.state.shouldToggle = false;
                _this.state.maximumStep = screen;
                _this.state.currentStep = screen;
                _this.state.shouldToggle = true;
                return screen;
            });
        };
        this.closeNewAddressForm = function () {
            if (_this.state.currentStep == Screen.PAYMENT)
        ...
        this.handleAccountResponse = function (data) {
            var _a, _b, _c;
            var existingAccountID = (_a = _this.account) === null || _a === void 0 ? void 0 : _a.accountID;
            _this.account = data.account;
            var setDefault = true;
            var hardRefresh = false;
            if (_this.account.accountID != existingAccountID) {
                hardRefresh = true;
            }
            if (_this.account.accountStatusType && _this.account.accountStatusType.systemCode == 'astEnrollmentPending') {
                _this.hasSponsor = (_c = (_b = _this.account.ownerAccount) === null || _b === void 0 ? void 0 : _b.accountID) === null || _c === void 0 ? void 0 : _c.length;
                setDefault = false;
                hardRefresh = true;
            }
            if (data.messages) {
                _this.publicService.messages = data.messages;
            }
            if (!_this.account.accountID.length)
                return;
            _this.getCurrentCheckoutScreen(setDefault, hardRefresh);
        };
        this.preValidate = function (model) {
            var emptyZip = false;
            ...
            if (model.countryCode && model.countryCode == "IE" && !_this.formHasBeenPosted && emptyZip) {
                _this.formHasBeenPosted = true;
    ...
    MonatCheckoutController.prototype.setCheckoutDefaults = function () {
        var _this = this;
        var _a, _b;
        if (!((_b = (_a = this.publicService.cart) === null || _a === void 0 ? void 0 : _a.orderID) === null || _b === void 0 ? void 0 : _b.length)
    ...
    MonatCheckoutController.prototype.calculateListPrice = function () {
        ...
        if (this.state.cart && this.state.cart.orderItems) {
            for (var _i = 0, _a = this.state.cart.orderItems; _i < _a.length; _i++) {
                var item = _a[_i];
...
var PromoModalController = /** @class */ (function () {
    //@ngInject
    PromoModalController.$inject = ["rbkeyService", "observerService", "publicService", "monatService", "ModalService", "monatAlertService", "$timeout"];
    function PromoModalController(rbkeyService, observerService, publicService, monatService, ModalService, monatAlertService, $timeout) {
        var _this = this;
        this.rbkeyService = rbkeyService;
        this.observerService = observerService;
        this.publicService = publicService;
        ...
        this.slickContainerID = '#promo-modal-content';
        this.$onInit = function () {
            _this.initSlickSlider();
        };
        this.formatPromotions = function (promotions) {
        ...
        this.viewPromotion = function (promotion) {
            _this.selectedPromotion = promotion;
            _this.takeOfferLoading = true;
            _this.monatService.getPromotionRewardSkus(_this.selectedPromotion.promotionRewardID).then(function (skuArray) {
                _this.rewardSkus = _this.formatRewardSkus(skuArray);
                _this.selectedPromotion.currentUseCount = 0;
                _this.currentPage = 'reward';
                _this.takeOfferLoading = false;
            });
            _this.setCurrentQualificationLimits(_this.selectedPromotion);
        };
        this.formatRewardSkus = function (skuArray) {
            for (var _i = 0, skuArray_1 = skuArray; _i < skuArray_1.length; _i++) {
                var sku = skuArray_1[_i];
                ...
                var adjustmentAmount = _this.selectedPromotion.amount;
                var adjustmentType = _this.selectedPromotion.amountType;
        ...
        this.updateQuantity = function (sku, delta) {
            sku.addToCartQuantity += delta;
            _this.selectedPromotion.currentUseCount += delta;
            if ((_this.maxUseCount && _this.selectedPromotion.currentUseCount > _this.maxUseCount)
                || (_this.maxUsePerItem && sku.addToCartQuantity > _this.maxUsePerItem)
                || sku.addToCartQuantity > sku.stocks_calculatedQATS
                || sku.addToCartQuantity < 0) {
                _this.updateQuantity(sku, -delta);
            }
        };
        this.addToCart = function () {
            var skuIds = [], quantities = [];
            for (var _i = 0, _a = _this.rewardSkus; _i < _a.length; _i++) {
                var sku = _a[_i];
            ...
            if (skuIds.length) {
                ...
                _this.monatService.addMultipleToCart(data).then(function (result) {
                    if (result.hasErrors) {
                        _this.monatAlertService.showErrorsFromResponse(result);
                    }
                    else {
                        _this.$timeout(function () { return _this.monatService.cart.rewardAddToCartMessage = _this.rbkeyService.rbKey('alert.cart.addProductSuccessful'); });
                    }
                }).catch(function (err) {
                    console.error(err);
                    _this.monatAlertService.showErrorsFromResponse(err);
                }).finally(function () {
                    _this.loading = false;
                });
            }
        ...
        this.slickPrev = function () {
            var slickContainer = $(_this.slickContainerID);
    ...
    PromoModalController.prototype.setCurrentQualificationLimits = function (promotion) {
        var maxUseCount;
        var qualifications = parseInt(promotion.qualifications);
        var maxUsePerQualification = parseInt(promotion.maximumUsePerQualification);
        var maxUsePerOrder = parseInt(promotion.maximumUsePerOrder);
        var maxUsePerItem = parseInt(promotion.maximumUsePerItem);
    ...
    return PromoModalController;
}());
var PromoModal = /** @class */ (function () {
    function PromoModal() {
        this.restrict = 'E';
        this.scope = {};
        this.bindToController = {
        ...
        this.controller = PromoModalController;
        this.controllerAs = "promoModal";
        this.template = __webpack_require__("Vd4i");
        this.link = function (scope, element, attrs) {
        };
    }
    PromoModal.Factory = function () {
        var _this = this;
        return function () { return new _this(); };
    };
    return PromoModal;
}());
exports.PromoModal = PromoModal;
...
var MonatOrderItemsController = /** @class */ (function () {
    ...
    function MonatOrderItemsController(monatService, orderTemplateService, publicService, observerService, $scope, $timeout, sessionStorageCache) {
        ...
        this.observerService.attach(function (data) {
            _this.updateOrderItems(data);
        }, 'updatedCart');
    }
...
var save_enrollment_modal_1 = __webpack_require__("9/uh");
var promo_modal_1 = __webpack_require__("FEAO");
...
var publicservice_1 = __webpack_require__("Xepx");
...
var monatfrontendmodule = angular
    ...
    .directive("saveEnrollmentModal", save_enrollment_modal_1.SaveEnrollmentModal.Factory())
    .directive("promoModal", promo_modal_1.PromoModal.Factory())
    ...
    .directive("filterMenu", monat_filter_menu_1.MonatFilterMenu.Factory())
    // Controllers
    ...
    .controller("navbarController", navbar_1.MonatNavbarController)
...
var SWFPaginationController = /** @class */ (function () {
    ...
    function SWFPaginationController(observerService, $scope, publicService, $q) {
        ...
        this.init = function () {
            ...
            _this.hasNextPageSet = _this.pageTracker != _this.totalPages;
            _this.displayPagination = _this.hasNextPageSet;
        ...
        this.paginate = function (pageNumber, direction, newPages) {
            var _a, _b;
            if (pageNumber === void 0) { pageNumber = 1; }
            ...
            if ((_b = (_a = _this.publicService.account) === null || _a === void 0 ? void 0 : _a.priceGroups) === null || _b === void 0 ? void 0 : _b.length) {
                _this.argumentsObject['priceGroupCode'] = _this.publicService.account.priceGroups[0].priceGroupCode;
            }
            ...
            if (_this.pageCache[pageCacheKey]) {
                ...
                _this.publicService.doAction(_this.action, _this.argumentsObject, _this.httpMethod).then(function (result) {
        ...
        this.handlePageResponse = function (deferred, result, pageNumber, pageCacheKey) {
            ...
            if (_this.totalPages) {
                _this.hasNextPageSet = pageNumber < _this.totalPages;
            }
            else {
                _this.hasNextPageSet = (Array.isArray(_this.recordList) ? _this.recordList.length : Object.keys(_this.recordList).length) == _this.itemsPerPage;
            }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MonatNavbarController = void 0;
var MonatNavbarController = /** @class */ (function () {
    // @ngInject
    MonatNavbarController.$inject = ["observerService", "monatService", "ModalService", "rbkeyService"];
    function MonatNavbarController(observerService, monatService, ModalService, rbkeyService) {
        var _this = this;
        this.observerService = observerService;
        this.monatService = monatService;
        this.ModalService = ModalService;
        ...
        this.saveEnrollment = function () {
            _this.ModalService.showModal({
                ...
                bodyClass: 'angular-modal-service-active',
                bindings: {
                    title: _this.rbkeyService.rbKey('frontend.enrollment.saveEnrollment'),
                },
                preClose: function (modal) {
                    modal.element.modal('hide');
                },
    ...
    return MonatNavbarController;
}());
exports.MonatNavbarController = MonatNavbarController;
    ...
    FlexshipFlowController.prototype.getCanViewOFYStep = function () {
        ...
        if (this.currentStep === FlexshipSteps.SHOP) {
            ...
            this.publicService.doAction('getOrderTemplatePromotionSkus', data).then(function (result) {
                ...
                var _a;
                _this.isOFYEligible = (_this.orderTemplate.scheduleOrderDayOfTheMonth
                    && _this.orderTemplate.scheduleOrderDayOfTheMonth > today
                    && _this.orderTemplate.qualifiesForOFYProducts
                    && ((_a = _this.ofyProducts) === null || _a === void 0 ? void 0 : _a.length));
                return _this.isOFYEligible;
            });
        }
        else {
...
var OrderTemplateService = /** @class */ (function () {
    //@ngInject
    OrderTemplateService.$inject = ["$q", "monatService", "publicService", "$timeout"];
    function OrderTemplateService($q, monatService, publicService, $timeout) {
        var _this = this;
        this.$q = $q;
        this.monatService = monatService;
        this.publicService = publicService;
        ...
        this.cartTotalThresholdForOFYAndFreeShippingLoaded = false;
        this.wishlistsRefreshed = false;
        this.showPurchasePlusMessage = false;
        /**
        ...
        */
        this.updateOrderTemplateSchedule = function (data) {
            return _this.publicService.doAction("updateOrderTemplateSchedule", data);
        };
        this.updateOrderTemplateFrequency = function (orderTemplateID, frequencyTermID, scheduleOrderDayOfTheMonth) {
            ...
            _this.publicService.doAction("updateOrderTemplateFrequency", payload).then(function (res) {
        ...
        */
        this.addOrderTemplateItem = function (skuID, orderTemplateID, quantity, temporaryFlag, optionalData) {
            ...
            _this.publicService.doAction('addOrderTemplateItem', optionalData).then(function (res) {
                if (res.orderTemplate) {
                    _this.newOrderTemplateData = true;
    ...
    OrderTemplateService.prototype.updateOrderTemplateDataOnService = function (orderTemplate) {
        ...
        this.showPurchasePlusMessage = ((_c = (_b = this.mostRecentOrderTemplate['purchasePlusMessage']) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.length) || false;
        var hasReachedThreshold = this.cartTotalThresholdForOFYAndFreeShipping - this.mostRecentOrderTemplate.calculatedSubTotal <= 0;
        this.showThresholdMessage = (!this.hasShownThresholdMessage && hasReachedThreshold);
        this.$timeout(function () {
            _this.showThresholdMessage = false;
            _this.newOrderTemplateData = false;
            _this.showPurchasePlusMessage = false;
        }, 6000);
...
module.exports = "<div ng-if=\"promoModal.currentPage == 'promoList'\" ng-show=\"promoModal.slickInitialized\" id=\"qualifiedPromoBanner\" class=\"modal using-modal-service\" tabindex=\"-1\" role=\"dialog\">\n  <div class=\"modal-dialog modal-dialog-centered\" role=\"document\" id=\"promo-modal-content\">\n    <div class=\"modal-content\" ng-repeat=\"promotion in promoModal.promotions\" ng-init=\"$last && promoModal.initSlickSlider()\">\n      <div class=\"modal-header\">\n\t\t    <img src=\"/themes/monat/assets/images/icon-promo.png\">\n      \t<div class=\"unlocked\" sw-rbkey=\"'frontend.global.youveUnlocked'\"></div>\n        <h5 class=\"modal-title\" ng-bind=\"promotion.title\"></h5>\n        <button type=\"button\" class=\"close\" ng-click=\"promoModal.close()\" aria-label=\"Close\">\n          <span aria-hidden=\"true\"><i class=\"fal fa-minus\"></i></span>\n        </button>\n      </div>\n      <div class=\"modal-body\">\n        <p ng-bind=\"promotion.description\"></p>\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn bg-white\" ng-click=\"promoModal.viewPromotion(promotion)\" ng-disabled=\"promoModal.takeOfferLoading\" ng-class=\"{'loading':promoModal.takeOfferLoading}\">\n        \t<span sw-rbkey=\"'frontend.global.takeOffer'\"></span>\n        </button>\n      </div>\n      <!--- TODO: only display this div if there is more than one promo available --->\n      <div class=\"slickActions\" ng-if=\"promoModal.promotions.length > 1\">\n        <button type=\"button\" class=\"slick-prev\" ng-click=\"promoModal.slickPrev()\" sw-rbkey=\"'frontend.global.previous'\"></button>\n        <button type=\"button\" class=\"slick-next\" ng-click=\"promoModal.slickNext()\" sw-rbkey=\"'frontend.global.next'\"></button>\n      </div>\n    </div>\n  </div>\n</div>\n\n<div ng-if=\"promoModal.currentPage == 'reward'\" id=\"rewards-modal\" class=\"modal using-modal-service\" tabindex=\"-1\" role=\"dialog\">\n  <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <div class=\"container-fluid\">\n          <div class=\"row align-items-center justify-content-between flex-nowrap\">\n            <div class=\"header pr-3\" ng-bind=\"promoModal.selectedPromotion.rewardHeader\">\n            </div>\n            <div ng-if=\"promoModal.maxUseCount\" class=\"pl-3 d-flex flex-column header-right\">\n                <span class=\"small\" sw-rbkey=\"'frontend.global.qualify'\"></span>\n                <span>\n                    X {{promoModal.maxUseCount}}\n                </span>\n            </div>\n            <button type=\"button\" class=\"flex-column close\" data-dismiss=\"modal\" aria-label=\"Close\">\n              <span aria-hidden=\"true\"><i class=\"fal fa-times\"></i></span>\n            </button>\n          </div> \n        </div>\n      </div>\n      <div class=\"modal-body p-0\">\n         <ul class=\"list-group\">\n             <!---- start repeat for products ---->\n             <li class=\"list-item\" ng-repeat=\"rewardSku in promoModal.rewardSkus\">\n                 <div class=\"product-image mr-2\">\n                    <img \n                        image-manager\n                        ng-src=\"{{rewardSku.imagePath}}\" \n                        alt=\"{{rewardSku.title}}\"\n                        width=\"70\" \n                        height=\"70\" \n                    />\n                 </div>\n                 <div class=\"product-details mr-1 d-flex flex-column justify-content-center align-items-start\">\n                     <span class=\"product-title\" ng-bind=\"rewardSku.title\"></span>\n                    <div class=\"d-flex justify-content-between price border-bottom-0 pb-1\">\n                        <span class=\"price-1 mr-1\" ng-bind=\"rewardSku.listPrice | swcurrency:promoModal.cart.currencyCode\"></span>\n                        <span class=\"price-2\" ng-bind=\"rewardSku.price | swcurrency:promoModal.cart.currencyCode\"></span>\n                    </div>\n                 </div>\n                 <div class=\"d-flex justify-content-end align-items-center pr-2\">\n                    <div class=\"adjust-quantity\" ng-click=\"promoModal.updateQuantity(rewardSku,-1)\">-</div>\n                    <span ng-bind=\"rewardSku.addToCartQuantity || 0\"></span>\n                    <div class=\"adjust-quantity\" ng-click=\"promoModal.updateQuantity(rewardSku,1)\">+</div>\n                 </div>\n             </li>\n             <!---- end repeat for products ---->\n         </ul> \n      </div>\n      <div class=\"modal-footer\">\n        <button \n          type=\"button\" \n          class=\"btn\" \n          ng-disabled=\"promoModal.loading \" \n          ng-class=\"{ loading: promoModal.loading }\" \n          ng-click=\"promoModal.addToCart()\" \n          sw-rbkey=\"'frontend.global.addToCart'\">\n          \n        </button>\n      </div>\n    </div>\n  </div>\n</div>";
...
var PublicService = /** @class */ (function (_super) {
    ...
    function PublicService($http, $q, $window, $location, $hibachi, $injector, $httpParamSerializer, requestService, accountService, accountAddressService, cartService, orderService, observerService, appConfig, $timeout, hibachiAuthenticationService, sessionStorageCache, inMemoryCache) {
        var _this = _super.call(this, $http, $q, $window, $location, $hibachi, $injector, $httpParamSerializer, requestService, accountService, accountAddressService, cartService, orderService, observerService, appConfig, $timeout, hibachiAuthenticationService, sessionStorageCache, inMemoryCache) || this;
        _this.$http = $http;
        _this.$q = $q;
        _this.$window = $window;
        ...
        _this.hibachiAuthenticationService = hibachiAuthenticationService;
        _this.sessionStorageCache = sessionStorageCache;
        _this.inMemoryCache = inMemoryCache;
        ...
        */
        _this.doAction = function (action, data, method) {
            ...
            if (angular.isDefined(_this.cmsSiteID)) {
        ...
        _this.getAccount = function (refresh) {
            ...
            if (refresh || !cachedAccount) {
                ...
                _this.accountDataPromise
                    ...
                    _this.removeFromSessionCache("cachedAccount");
                    deferred.reject(e);
                });
            }
            else {
                console.log('Getting from Cache', cachedAccount['account']);
                _this['account'].populate(cachedAccount['account']);
                deferred.resolve(cachedAccount);
            }
            return deferred.promise;
        };
        _this.processAction = function (response, request) {
            ...
            if (response.account) {
                ...
                _this.putIntoSessionCache("cachedAccount", { 'account': response.account });
            }
            if (response.cart) {
        ...
        _this.getData = function (url, setter, param, method) {
            if (method === void 0) { method = 'post'; }
            ...
            request.promise.then(function (result) {
                ...
                if (setter.indexOf('account') == -1) {
                    if (result['account']) {
                        _this.putIntoSessionCache("cachedAccount", { 'account': result['account'] });
...
var MonatProductModalController = /** @class */ (function () {
    //@ngInject
    MonatProductModalController.$inject = ["monatService", "observerService", "rbkeyService", "orderTemplateService", "monatAlertService", "publicService", "$sce", "$timeout"];
    function MonatProductModalController(monatService, observerService, rbkeyService, orderTemplateService, monatAlertService, publicService, $sce, $timeout) {
        var _this = this;
        this.monatService = monatService;
        this.observerService = observerService;
        this.rbkeyService = rbkeyService;
        ...
        this.getModalInfo = function () {
            var _a, _b;
            var argumentsObject = { skuID: _this.product.skuID };
            if ((_b = (_a = _this.publicService.account) === null || _a === void 0 ? void 0 : _a.priceGroups) === null || _b === void 0 ? void 0 : _b.length) {
                argumentsObject['priceGroupCode'] = _this.publicService.account.priceGroups[0].priceGroupCode;
            }
            _this.publicService.doAction('getQuickShopModalBySkuID', argumentsObject, 'GET').then(function (data) {
        ...
        this.addToCart = function () {
            ...
            _this.monatService.addToCart(_this.product.skuID, _this.quantityToAdd)
                .then(function (result) {
                if (!result.hasErrors) {
                    var origText_1 = _this.translations['addButtonText'];
                    _this.translations['addButtonText'] = _this.rbkeyService.rbKey("alert.flexship.addedToCart");
                    _this.loaded = true;
                    _this.$timeout(function () {
                        _this.closeModal();
                        _this.loaded = false;
                        _this.translations['addButtonText'] = origText_1;
                    }, 3000);
                }
                else {
                    _this.monatAlertService.showErrorsFromResponse(result);
...
var MonatEnrollmentController = /** @class */ (function () {
    //@ngInject
    MonatEnrollmentController.$inject = ["monatService", "observerService", "$rootScope", "publicService", "orderTemplateService", "sessionStorageCache", "monatAlertService", "rbkeyService", "ModalService"];
    function MonatEnrollmentController(monatService, observerService, $rootScope, publicService, orderTemplateService, sessionStorageCache, monatAlertService, rbkeyService, ModalService) {
        var _this = this;
        this.monatService = monatService;
        this.observerService = observerService;
        this.$rootScope = $rootScope;
            ...
            _this.publicService.getAccount().then(function (result) {
                ...
                _this.monatService.getCart().then(function (res) {
                    ...
                    if (!_this.upgradeFlow) {
                        ...
                        else if (cart.orderItems && cart.orderItems.length && _this.currentStepName == 'starterPack') {
                            _this.goToStep('todaysOrder');
                            _this.reviewContext = false;
                        }
                    }
...
var FrequencyStepController = /** @class */ (function () {
    ...
    function FrequencyStepController(monatService, orderTemplateService, observerService) {
        ...
        this.$onInit = function () {
            _this.getFrequencyTermOptions();
            _this.orderTemplate = _this.orderTemplateService.mostRecentOrderTemplate;
        };
        this.getFrequencyTermOptions = function () {
            _this.monatService.getOptions({ 'frequencyTermOptions': false }).then(function (response) {
                _this.frequencyTerms = response.frequencyTermOptions;
                if (_this.orderTemplate.frequencyTerm_termID) {
                    for (var _i = 0, _a = _this.frequencyTerms; _i < _a.length; _i++) {
                        var term = _a[_i];
                        if (term.value == _this.orderTemplate.frequencyTerm_termID) {
                            _this.term = term;
                        }
                    }
                }
                ...
                if (_this.orderTemplate.scheduleOrderDayOfTheMonth) {
                    _this.day = _this.orderTemplate.scheduleOrderDayOfTheMonth;
                }
                else {
...
var EnrollmentMPController = /** @class */ (function () {
    // @ngInject
    EnrollmentMPController.$inject = ["publicService", "observerService", "monatService", "rbkeyService", "monatAlertService", "$timeout"];
    function EnrollmentMPController(publicService, observerService, monatService, rbkeyService, monatAlertService, $timeout) {
        var _this = this;
        this.publicService = publicService;
        this.observerService = observerService;
        this.monatService = monatService;
        ...
        this.showProductFilter = {};
        this.sortedBundles = [];
        this.selectedBundleInCart = false;
        this.$onInit = function () {
            _this.getDateOptions();
            ...
            _this.publicService
                ...
                for (var bundle in _this.bundles) {
                    ...
                    var bundleInCart = _this.checkIfBundleIsInCart(_this.bundles[bundle]['ID']);
                    if (bundleInCart) {
                        _this.selectedBundleID = _this.bundles[bundle]['ID'];
                        _this.selectedBundleInCart = true;
                    }
                }
        ...
        this.checkIfBundleIsInCart = function (bundleID) {
            var _a;
            var bundleInCart = false;
            if ((_a = _this.monatService.cart) === null || _a === void 0 ? void 0 : _a.orderItems) {
                for (var _i = 0, _b = _this.monatService.cart.orderItems; _i < _b.length; _i++) {
                    var item = _b[_i];
        ...
        this.openBundle = function (bundle) {
            _this.openedBundle = bundle;
            if (_this.openedBundle == null) {
                _this.slickInitialized = false;
                return;
            }
            var slickContainer = $('.starter-pack-slick');
            _this.$timeout(function () {
                var slickOptions = JSON.parse(slickContainer[0].dataset.slickOptions);
                slickContainer.slick(slickOptions);
                _this.slickInitialized = true;
            });
        };
        ...
        this.selectBundle = function (bundleID, $event) {
            $event.preventDefault();
            _this.selectedBundleID = bundleID;
            _this.selectedBundleInCart = _this.checkIfBundleIsInCart(bundleID);
            _this.bundleErrors = [];
        };
        this.stripHtml = function (html) {
            var tmp = document.createElement('div');
...
var MonatProductListingController = /** @class */ (function () {
    // @ngInject
    MonatProductListingController.$inject = ["$rootScope", "publicService", "observerService", "$timeout", "monatService", "monatAlertService", "orderTemplateService", "rbkeyService", "ModalService"];
    function MonatProductListingController($rootScope, publicService, observerService, $timeout, monatService, monatAlertService, orderTemplateService, rbkeyService, ModalService) {
        var _this = this;
        this.$rootScope = $rootScope;
        this.publicService = publicService;
        this.observerService = observerService;
        ...
        this.productFilterTitle = "";
        this.$onInit = function () {
            _this.monatService.getCart(); // monat-service caches cart in session-cache for 15 min
        ...
        this.getProducts = function (category, categoryType) {
            ...
            _this.publicService.doAction('getProductsByCategoryOrContentID', _this.argumentsObject, 'GET').then(function (result) {
                _this.productList = result.productList;
        ...
        this.addToCart = function (skuID, quantity) {
            ...
            _this.monatService.addToCart(skuID, quantity)
                .then(function (data) {
                if (data.hasErrors) {
                    _this.monatAlertService.showErrorsFromResponse(data);
                }
            })
                .catch(function (error) {
                console.error(error);
        ...
        this.launchPromoModal = function () {
            _this.ModalService.showModal({
                component: 'promoModal',
                bodyClass: 'angular-modal-service-active',
                bindings: {
                    title: _this.rbkeyService.rbKey('frontend.enrollment.promoModal'),
                },
                preClose: function (modal) {
                    modal.element.modal('hide');
                },
...
var HybridCartController = /** @class */ (function () {
    //@ngInject
    HybridCartController.$inject = ["monatAlertService", "monatService", "observerService", "orderTemplateService", "$timeout", "publicService"];
    function HybridCartController(monatAlertService, monatService, observerService, orderTemplateService, $timeout, publicService) {
        var _this = this;
        this.monatAlertService = monatAlertService;
        this.monatService = monatService;
        this.observerService = observerService;
        ...
        this.removeItem = function (item) {
            ...
            _this.monatService.removeFromCart(item.orderItemID).then(function (res) {
                if (res.hasErrors) {
                    _this.monatAlertService.showErrorsFromResponse(res);
                }
                _this.loading = false;
            });
        };
    ...
    HybridCartController.prototype.getCart = function (refresh, toggleCart) {
        var _this = this;
        if (refresh === void 0) { refresh = false; }
        if (toggleCart === void 0) { toggleCart = false; }
...
module.exports = "\t\t\t\t\t\t\t<a href=\"\" class=\"filter-btn\" ng-click=\"monatFilterMenu.toggleFilterMenu()\">\n\t\t\t\t\t\t\t\t<span sw-rbkey=\"'frontend.global.filterBy'\"></span>\n\t\t\t\t\t\t\t\t<img src=\"/themes/monat/assets/images/FilterBy.svg\" alt=\"filter icon\" />\n\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t<div \n\t\t\t\t\t\t\tsw-click-outside=\"monatFilterMenu.showFilterMenu = false\"\n\t\t\t\t\t\t\tng-class=\"{\n\t\t\t\t\t\t\t'show-filter-menu' : monatFilterMenu.showFilterMenu,\n\t\t\t\t\t\t\t'hide-filter-menu' : !monatFilterMenu.showFilterMenu,\n\t\t\t\t\t\t\t'show-main-menu' : monatFilterMenu.showMainFilterMenu,\n\t\t\t\t\t\t\t'show-sub-menu' : !monatFilterMenu.showMainFilterMenu\n\t\t\t\t\t\t\t}\"\n\t\t\t\t\t\t\tng-show=\"monatFilterMenu.showFilterMenu\"\n\t\t\t\t\t\t\tclass=\"filter-container\"\n\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t<div class=\"filter-menu main-filter-menu\" style=\"padding-top: {{monatFilterMenu.headerHeight}}px\">\n\t\t\t\t\t\t\t\t<div class=\"filter-title-row\"> \n\t\t\t\t\t\t\t\t\t<i class=\"fal fa-angle-left\" ng-click=\"monatFilterMenu.showFilterMenu = false\"></i>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"filter-title-row\">\n\t\t\t\t\t\t\t\t\t<span sw-rbkey=\"'frontend.global.shopBy'\"> {{monatFilterMenu.parentController.name}}</span>\n\t\t\t\t\t\t\t\t\t<a\n\t\t\t\t\t\t\t\t\t\tsw-rbkey=\"'frontend.global.clearAll'\"\n\t\t\t\t\t\t\t\t\t\tng-click=\"monatFilterMenu.clearFilter(); monatFilterMenu.callProductFunction('none', 'none');\"\n\t\t\t\t\t\t\t\t\t></a>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t\t\t<ul class=\"filter-col\">\n\t\t\t\t\t\t\t\t\t\t<li ng-repeat=\"categoryName in monatFilterMenu.monatService.productFilterCategories\" ng-click=\"monatFilterMenu.toggleFilterSubCategory(categoryName); monatFilterMenu.clearFilter();\">\n\t\t\t\t\t\t\t\t\t\t\t<span>{{categoryName}}</span>\n\t\t\t\t\t\t\t\t\t\t\t<i class=\"far fa-angle-right\"></i>\n\t\t\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<!--- \n\t\t\t\t\t\t\t\t<div class=\"promotion-box text-white\" style=\"background-color: ##7E70C5\">\n\t\t\t\t\t\t\t\t\t<div class=\"promotion-header\">$22 + 3</div>\n\t\t\t\t\t\t\t\t\t<div class=\"promotion-summary\">Purchase a new Product for $22 MP/$27 VIP,\n\t\t\t\t\t\t\t\t\tGet a Shampoo, Styling, and Finishing Item, plus a Free Hairbrush for $47 MP/$57 VIP\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div> --->\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</div> <!--- end .main-filter-menu --->\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t<div class=\"filter-menu sub-filter-menu\" style=\"padding-top: {{monatFilterMenu.headerHeight}}px\">\n\t\t\t\t\t\t\t\t<div class=\"filter-title-row\"> \n\t\t\t\t\t\t\t\t\t<i class=\"fal fa-angle-left\" ng-click=\"monatFilterMenu.showMainFilterMenu = true;\"></i> \n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"filter-title-row\">\n\t\t\t\t\t\t\t\t\t<span sw-rbkey=\"'frontend.global.shopBy'\"> {{monatFilterMenu.filterCategory}}</span>\n\t\t\t\t\t\t\t\t\t<a href=\"\"\n\t\t\t\t\t\t\t\t\t\tsw-rbkey=\"'frontend.global.clearAll'\"\n\t\t\t\t\t\t\t\t\t\tng-click=\"monatFilterMenu.clearFilter(); monatFilterMenu.callProductFunction('none', 'none')\"\n\t\t\t\t\t\t\t\t\t></a>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t\t\t<ul class=\"filter-col\" >\n\t\t\t\t\t\t\t\t\t\t<li ng-repeat=\"filter in monatFilterMenu.monatService.productFilters[monatFilterMenu.filterCategory]\" ng-if=\"!$first\">\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"custom-radio radio\">\n\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" \n\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"custom-control-label\" \n\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" \n\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"{{monatFilterMenu.filterCategory}}-{{filter.name}}\"\n\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"{{monatFilterMenu.filterCategory}}-filterOptionButton\" \n\t\t\t\t\t\t\t\t\t\t\t\t\tng-click=\n\t\t\t\t\t\t\t\t\t\t\t\t\t\"monatFilterMenu.callProductFunction(filter,categoryName); \n\t\t\t\t\t\t\t\t\t\t\t\t\tmonatFilterMenu.setParentTitle(filter.name);\"\n\t\t\t\t\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\t\t\t\t\t<label \n\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"custom-control-label\" \n\t\t\t\t\t\t\t\t\t\t\t\t\tfor=\"{{monatFilterMenu.filterCategory}}-{{filter.name}}\"\n\t\t\t\t\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\t\t\t\t\t\t{{filter.name}}\n\t\t\t\t\t\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div><!--- end .sub-filter-menu --->\n\t\t\t\t\t\t</div><!--- end .filter-container --->\n\t\t\t\t\n\t\t\t\t\t";
...
var VIPUpgradeController = /** @class */ (function () {
    ...
    function VIPUpgradeController(publicService, observerService, monatService, orderTemplateService) {
        ...
        this.getProductList = function () {
            _this.loading = true;
            _this.publicService.doAction('getProductsByCategoryOrContentID', { priceGroupCode: 3 }, 'GET').then(function (result) {
                _this.productList = result.productList;
                _this.recordsCount = result.recordsCount;
                _this.observerService.notify('PromiseComplete');
                _this.loading = false;
...
var MonatProductCardController = /** @class */ (function () {
    // @ngInject
    MonatProductCardController.$inject = ["$scope", "$location", "$timeout", "ModalService", "monatService", "rbkeyService", "publicService", "observerService", "monatAlertService", "orderTemplateService"];
    function MonatProductCardController($scope, $location, $timeout, ModalService, monatService, rbkeyService, publicService, observerService, monatAlertService, orderTemplateService) {
        var _this = this;
        this.$scope = $scope;
        this.$location = $location;
        this.$timeout = $timeout;
    ...
    MonatProductCardController.prototype.addToCartToggle = function () {
        var _this = this;
        this.loaded = true;
        this.$timeout(function () {
            _this.loaded = false;
...
var WishlistEditModalConroller = /** @class */ (function () {
    ...
    function WishlistEditModalConroller(rbkeyService, observerService) {
        ...
        this.$onInit = function () {
            _this.makeTranslations();
            _this.wishlistName = _this.wishlist.name;
        };
        this.makeTranslations = function () {
            //TODO make translations for success/failure alert messages
            _this.translations['wishlistName'] = _this.rbkeyService.rbKey('frontend.wishlist.name');
        ...
        this.closeModal = function () {
            _this.close(_this.wishlistName);
        };
...
module.exports = "<!---- Send Enrollment modal --->\n<div class=\"modal using-modal-service slide-out-modal\" id=\"save-enrollment\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"save-enrollment\" aria-hidden=\"true\">\n\t<div class=\"modal-dialog\" role=\"document\">\n\t\t<div class=\"modal-content\">\n\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n\t\t\t\t<i class=\"far fa-chevron-left\"></i> <span sw-rbKey=\"'frontend.global.back'\"></span>\n\t\t\t</button>\n\t\t\t<div class=\"modal-body\">\n\t\t\t\t<img src=\"/themes/monat/assets/images/send-icon.png\"  alt=\"Save Enrollment\" width=\"45px\" height=\"auto\">\n\t\t\t\t<h3 class=\"text-center mb-2 mb-md-4\" sw-rbKey=\"'frontend.enrollment.sendEnrollmentTitle'\"></h3>\n\n\t\t\t\t<div class=\"material-field\">\n\t\t\t\t\t<input \n\t\t\t\t\t\tid=\"receiverName\" \n\t\t\t\t\t\ttype=\"text\" \n\t\t\t\t\t\tname=\"name\" \n\t\t\t\t\t\tclass=\"form-control success\" \n\t\t\t\t\t\tng-model=\"saveEnrollmentModal.name\" \n\t\t\t\t\t\tswvalidationrequired=\"false\"\n\t\t\t\t\t>\n\t\t\t\t\t<label for=\"receiverName\">\n\t\t\t\t\t\t<span sw-rbkey=\"'frontend.enrollment.firstLastName'\"></span>\n\t\t\t\t\t</label>\n\t\t\t\t\t<sw:SwfErrorDisplay propertyIdentifier=\"receiverName\" />\n                </div>\n\t\t\t\t\n\t\t\t\t<div class=\"material-field\">\n\t\t\t\t\t<input \n\t\t\t\t\t\tid=\"receiverEmailAddress\" \n\t\t\t\t\t\ttype=\"email\" \n\t\t\t\t\t\tname=\"emailAddress\" \n\t\t\t\t\t\tclass=\"form-control success\" \n\t\t\t\t\t\tng-model=\"saveEnrollmentModal.emailAddress\" \n\t\t\t\t\t\tswvalidationdatatype=\"email\" \n\t\t\t\t\t\tswvalidationrequired=\"true\"\n\t\t\t\t\t>\n\t\t\t\t\t<label for=\"receiverEmailAddress\">\n\t\t\t\t\t\t<span sw-rbkey=\"'frontend.newAddress.emailAddress'\"></span>\n\t\t\t\t\t</label>\n\t\t\t\t\t<sw:SwfErrorDisplay propertyIdentifier=\"receiverEmailAddress\" />\n                </div>\n                \n                <button ng-disabled=\"saveEnrollmentModal.loading\" ng-class=\"{loading: saveEnrollmentModal.loading}\" ng-click=\"saveEnrollmentModal.saveEnrollment()\" value=\"{{frontend.wishlist.send}}\" class=\"btn bg-primary save-btn px-5 py-3 mt-3 mt-md-5\"><span sw-rbKey=\"'frontend.wishlist.send'\"></span></buton>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n<!---- END: Send Enrollment modal --->";
    ...
    function swfAccountController(publicService, $scope, observerService, ModalService, rbkeyService, monatAlertService, $location, monatService) {
        ...
        this.getAccountData = function (data) {
            ...
            if ((_b = _this.accountData.accountID) === null || _b === void 0 ? void 0 : _b.trim()) {
                if ('astEnrollmentPending' == ((_c = _this.accountData.accountStatusType) === null || _c === void 0 ? void 0 : _c.systemCode)) {
                ...
                if (((_e = (_d = _this.accountData) === null || _d === void 0 ? void 0 : _d.accountType) === null || _e === void 0 ? void 0 : _e.toLowerCase()) == 'marketpartner') {
                    _this.loading = true;
        ...
        this.getOrderItemsByOrderID = function (orderID, pageRecordsShow, currentPage) {
            ...
            return _this.publicService.doAction("getOrderItemsByOrderID", {
                ...
                if (result.OrderItemsByOrderID) {
                    ...
                    _this.orderDeliveries = result.OrderItemsByOrderID.orderDeliveries;
        ...
        this.showEditWishlistModal = function () {
            _this.ModalService.showModal({
                ...
                modal.close.then(function (result) {
                    if (result) {
                        _this.holdingWishlist.name = result;
                    }
                });
            })
                .catch(function (error) {
        ...
        this.$onInit = function () {
            if (_this.flexship) {
                ...
                _this.monatService.getOFYItemsForOrder().then(function (res) {
                    ...
                    _this.products = res;
                    if (_this.monatService.ofyStagedProductID) {
                        _this.stageProduct(_this.monatService.ofyStagedProductID);
                    }
                    if (_this.monatService.cart) {
                        for (var _i = 0, _a = _this.monatService.cart.orderItems; _i < _a.length; _i++) {
                            var item = _a[_i];
                            if (_this.stagedProductID) {
                                if (item.sku.skuID == _this.stagedProductID) {
                                    _this.selectedProductInCart = true;
                                }
                            }
                                ...
                                for (var _b = 0, _c = _this.products; _b < _c.length; _b++) {
                                    ...
                                    if (item.sku.skuID == product.skuID) {
                                        _this.stageProduct(product.skuID);
                                        _this.selectedProductInCart = true;
                                    }
                                }
                            }
            ...
            if (!_this.products) {
                _this.publicService.doAction(_this.endpoint, data).then(function (result) {
                    if (result.ofyProducts) {
                        result.ofyProducts = result.ofyProducts.filter(function (item) {
                            return item.calculatedQATS > 0;
                        });
                    }
...
module.exports = "<div class=\"manage\">\n\t<a href=\"##\" class=\"flexs\"><span sw-rbkey=\"'frontend.flexshipCard.menu.manageMyFlexship'\"></span> <i class=\"fas fa-chevron-down\"></i></a>\n\t<ul>\n\t\t<li ng-if=\"\n\t\t\t\tmonatFlexshipMenu.orderTemplate.billingAccountAddress_accountAddressID.trim().length \n\t            && monatFlexshipMenu.orderTemplate.shippingAccountAddress_accountAddressID.trim().length\n\t            && monatFlexshipMenu.orderTemplate.orderTemplateStatusType_systemCode === 'otstDraft'\n\t       \" \n\t    >\n\t\t    <a  ng-click=\"monatFlexshipMenu.activateFlexship()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.activateFlexship'\"></span></a>\n\t\t</li>\n\t\t\n\t\t<li>\n\t\t    <a ng-click=\"monatFlexshipMenu.showAddGiftCardModal()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.applyGiftCard'\"></span></a>\n\t\t</li>\n\t\t\n\t\t\n\t\t<li>\n\t\t    <a ng-click=\"monatFlexshipMenu.showFlexshipEditShippingMethodModal()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.editDeliveryAddress'\"></span></a>\n\t\t</li>\n\t\t\n\t\t<li>\n\t\t    <a ng-click=\"monatFlexshipMenu.goToProductListingPage()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.addOrRemoveItems'\"></span></a>\n\t\t</li>\n\t\n\t\t<li ng-if=\"monatFlexshipMenu.orderTemplate.qualifiesForOFYProducts\">\n\t\t    <a ng-click=\"monatFlexshipMenu.goToOFYProductListingPage()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.selectYourFreeProducts'\"></span></a>\n\t\t</li>\n\n\t\t<li>\n\t\t    <a ng-click=\"monatFlexshipMenu.showFlexshipEditPaymentMethodModal()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.editPaymentMethod'\"></span></a>\n\t\t</li>\n\n\t\t<li ng-if=\"monatFlexshipMenu.orderTemplate.orderTemplateStatusType_systemCode === 'otstActive'\" >\n\t\t    <a ng-click=\"monatFlexshipMenu.showFlexshipScheduleModal()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.editSchedule'\"></span></a>\n\t\t</li>\n\n\t\t\n\t\t<li ng-if=\"monatFlexshipMenu.orderTemplate.orderTemplateStatusType_systemCode === 'otstActive' && monatFlexshipMenu.publicService.account.accountType.toLowerCase() != 'vip' \">\n\t\t    <a ng-click=\"monatFlexshipMenu.showCancelFlexshipModal()\"><span sw-rbkey=\"'frontend.flexshipCard.menu.cancelFlexship'\"></span></a>\n\t\t</li>\n\t\t<li ng-if=\"monatFlexshipMenu.orderTemplate.orderTemplateStatusType_systemCode === 'otstDraft'\">\n\t\t    <a ng-click=\"monatFlexshipMenu.showDeleteFlexshipModal()\"><span sw-rbkey=\"'frontend.flexshipEdit.deleteFlexship'\"></span></a>\n\t\t</li>\n\t\t\n\t</ul>\n</div>\n\n\n\n";
...
/******/ });
//# sourceMappingURL=monatFrontend.99ef1e3b19b6d004abef.bundle.js.map