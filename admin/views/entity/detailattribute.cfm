	...
	<cf_HibachiEntityDetailForm object="#rc.attribute#" edit="#rc.edit#" 
		...
		<cf_HibachiPropertyRow>
			<cf_HibachiPropertyList>
				...
				<cf_HibachiDisplayToggle selector="select[name='attributeType.typeID']" valueAttribute="systemcode" showValues="atRelatedObjectSelect,atRelatedObjectMultiselect" loadVisable="#(!isNull(rc.attribute.getAttributeType()) && listFindNoCase('atRelatedObjectSelect,atReleatedObjectMultiselect', rc.attribute.getAttributeType().getSystemCode()))#">
