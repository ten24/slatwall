            ...
            SELECT 
    	        ...
    	        ( 
        			...
        			WHERE attributeOptionID IS NOT NULL
        			 AND  
	        ( productPublishedStartDateTime IS NULL OR productPublishedStartDateTime <= '5/17/21 4:07 PM' )
            AND ( productPublishedEndDateTime IS NULL OR productPublishedEndDateTime >= '5/17/21 4:07 PM' )
	     ...
	     AND (siteID = '2c9680847491ce86017491f46ec50036' OR siteID IS NULL) AND (  productTypeID = '2c938084760493a2017604ddc9091dcd' )
	        ...
	        /** Time Took 9694838717 in fetching 148 records*/
