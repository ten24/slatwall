...
*/
component displayname="Email Verification" entityname="SlatwallEmailVerification" table="SwEmailVerification" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" {
