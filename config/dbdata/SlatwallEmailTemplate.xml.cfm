...
<Table tableName="SwEmailTemplate">
	...
	<Records>
		...
		<Record emailTemplateID="fcb4f9102dad4936993018811f70b7a7" emailTemplateName="Update Primary Email Address" emailTemplateObject="Account" emailBodyHTML="Your primary email address has been changed." emailBodyText="Your primary email address has been changed." logEmailFlag="1" />
	</Records>
</Table>
