...
Object.defineProperty(exports, "__esModule", { value: true });
exports.PromoRewardModal = void 0;
var PromoRewardModalController = /** @class */ (function () {
    //@ngInject
    PromoRewardModalController.$inject = ["rbkeyService", "observerService", "publicService", "monatService", "ModalService"];
    function PromoRewardModalController(rbkeyService, observerService, publicService, monatService, ModalService) {
        var _this = this;
        this.rbkeyService = rbkeyService;
        this.observerService = observerService;
        this.publicService = publicService;
        ...
        this.launchPromoRewardModal = function () {
            if (_this.selectedPromotion) {
                _this.ModalService.showModal({
                    component: 'promoRewardModal',
                    bodyClass: 'angular-modal-service-active',
                    bindings: {
                        title: _this.rbkeyService.rbKey('frontend.enrollment.promoRewardModal'),
                    },
                    preClose: function (modal) {
                        modal.element.modal('hide');
                    },
    ...
    return PromoRewardModalController;
}());
var PromoRewardModal = /** @class */ (function () {
    function PromoRewardModal() {
        this.restrict = 'E';
        this.scope = {};
        this.bindToController = {
            close: '=' //injected by angularModalService
        };
        this.controller = PromoRewardModalController;
        this.controllerAs = "promoRewardModal";
        this.template = __webpack_require__("ogpD");
        this.link = function (scope, element, attrs) {
        };
    }
    PromoRewardModal.Factory = function () {
        var _this = this;
        return function () { return new _this(); };
    };
    return PromoRewardModal;
}());
exports.PromoRewardModal = PromoRewardModal;
...
var MonatService = /** @class */ (function () {
    ...
    function MonatService($q, $window, publicService, requestService, observerService, utilityService, localStorageCache, ModalService) {
        ...
        this.getQualifiedPromotionsForCart = function (cart) {
            _this.publicService.doAction('getQualifiedMerchandiseRewardsForOrder', { orderID: cart.orderID }).then(function (result) {
                _this.qualifiedPromos = result.rewards;
...
var PromoModalController = /** @class */ (function () {
    //@ngInject
    PromoModalController.$inject = ["rbkeyService", "observerService", "publicService", "monatService", "ModalService"];
    function PromoModalController(rbkeyService, observerService, publicService, monatService, ModalService) {
        var _this = this;
        this.rbkeyService = rbkeyService;
        this.observerService = observerService;
        this.publicService = publicService;
        ...
        this.addToCart = function () {
            ...
            if (data.skuIds.length) {
                _this.monatService.addMultipleToCart(data);
            }
        };
        this.closeModal = function () {
            _this.close(null);
...
var promo_reward_modal_1 = __webpack_require__("8tN+");
...
var monatfrontendmodule = angular
    ...
    .directive("promoRewardModal", promo_reward_modal_1.PromoRewardModal.Factory())
...
module.exports = "<div id=\"rewards-modal\" class=\"modal using-modal-service\" tabindex=\"-1\" role=\"dialog\">\n  <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n          <div class=\"container-fluid\">\n            <div class=\"row\">\n              <div class=\"col-9 pt-2\">\n                    Select Conditioner\n              </div>\n              <div class=\"col-3 d-flex flex-column header-right\">\n                  <span class=\"small\">\n                      Qualify\n                  </span>\n                  <span>\n                      X 3\n                  </span>\n              </div>\n            </div> \n          </div>\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n      </div>\n      <div class=\"modal-body\">\n         <ul class=\"list-group\">\n             <!---- start repeat for products ---->\n             <li class=\"list-item\">\n                 <div class=\"col-2 product-image\">\n                     Pro img\n                 </div>\n                 <div class=\"col-4 d-flex flex-column justify-content-around align-items-center\">\n                     <span class=\"product-title pl-1\">\n                        Product title \n                     </span>\n                    <div class=\"d-flex justify-content-between price border-bottom-0\">\n                        <span class=\"price-1 mr-1\">\n                            $35.00\n                        </span>\n                        <span class=\"price-2\">\n                            $10.00\n                        </span>\n                    </div>\n                 </div>\n                 <div class=\"col-6 d-flex justify-content-end align-items-center\">\n                    <div class=\"adjust-quantity\">-</div>\n                    <span>0</span>\n                    <div class=\"adjust-quantity\">+</div>\n                 </div>\n             </li>\n             <!---- end repeat for products ---->\n         </ul> \n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn\">Add to Cart</button>\n      </div>\n    </div>\n  </div>\n</div>";
...
/******/ });
//# sourceMappingURL=monatFrontend.6bdae76db2ebfc803d99.bundle.js.map