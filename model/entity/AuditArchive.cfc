...
*/
component entityname="SlatwallAuditArchive" table="SwAuditArchive" persistent="true" accessors="true" extends="HibachiEntity" hb_serviceName="HibachiAuditService" hb_defaultOrderProperty="auditDateTime" hb_auditable="false" {
	
	// Persistent Properties
	property name="auditArchiveID" ormtype="string" length="32" fieldtype="id" generator="uuid" unsavedvalue="" default="";
