...
Notes:
	...
	action
*/
component entityname="SlatwallPermission" table="SwPermission" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="accountService" hb_permission="permissionGroup.permissions" {
