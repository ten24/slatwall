...
class SWListingDisplayController{
    ...
    public exportAction:string;
    public adminattributes:string;
    public multiselectValues:string;
    public collectionConfig:any;
    public tableclass:string;
    public administrativeCount:number;
    public columnCount:number;
    public recordAddAction:string;
    public hasCollectionPromise:boolean;
    ...
    public processObjectProperties:string;
    public multiselectIdPaths:string;
    public childPropertyName:string;
    public parentPropertyName:string;
    public getChildCount:boolean;
    public multiselectFieldName:string;
    public multiselectPropertyIdentifier:string;
