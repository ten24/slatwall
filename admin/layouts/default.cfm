					...
					<div class="pull-right">
						<ul class="nav">
							<cfif $.slatwall.getLoggedInAsAdminFlag()>
								<hb:HibachiActionCallerDropdown title="" icon="user icon-white" dropdownclass="pull-right" type="nav">
							...
							<hb:HibachiActionCallerDropdown icon=" flag-icon flag-icon-#lcase(listLast($.slatwall.getRBLocale(), '_' ))#" dropdownclass="pull-right" type="nav">
