...
*/
component entityname="SlatwallSubscriptionUsageBenefitAccount" table="SwSubsUsageBenefitAccount" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="subscriptionService" hb_permission="subscriptionUsageBenefit.subscriptionUsageBenefitAccounts" {
