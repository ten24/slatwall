...
displayname='Avalara' 
extends='Slatwall.org.Hibachi.HibachiObject' {

	property name='avalaraService' type='any' persistent='false';

	public any function init() {
		
		setAvalaraService( getService('avalaraService') );

		return this;
	}
	
	/**
	 * helper function to return the value of a Setting
	 *	TODO: move to a common base-integrationType-file 
	 */
	...
	/**
	 * helper function to return the integration entity for this package 
	 *	TODO: move to a common base-integrationType-file 
	 */
	...
	/**
	 * helper function to return the The package name of this integration
	 */
