	...
	<hb:HibachiPropertyRow>
		...
		<hb:HibachiPropertyList divclass="col-md-6">
			...
			<hb:HibachiPropertyTable>
				...
				<hb:HibachiPropertyDisplay object="#rc.order#" property="estimatedFulfillmentDateTime" edit="false" displayType="table" title="#$.slatwall.rbKey('entity.define.estimatedFulfillmentDateTime')#" />
				<hb:HibachiPropertyDisplay object="#rc.order#" property="estimatedDeliveryDateTime" edit="false" displayType="table" title="#$.slatwall.rbKey('entity.define.estimatedDeliveryDateTime')#" />
				<hb:HibachiPropertyDisplay object="#rc.order#" property="nextEstimatedFulfillmentDateTime" edit="false" displayType="table" title="#$.slatwall.rbKey('entity.define.nextEstimatedFulfillmentDateTime')#" />
				<hb:HibachiPropertyDisplay object="#rc.order#" property="nextEstimatedDeliveryDateTime" edit="false" displayType="table" title="#$.slatwall.rbKey('entity.define.nextEstimatedDeliveryDateTime')#" />
