...
*/
component entityname="SlatwallApiRequestAudit" table="SwApiRequestAudit" persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="HibachiService" {

	// Persistent Properties
	property name="apiRequestAuditID" ormtype="string" length="32" fieldtype="id" generator="uuid" unsavedvalue="" default="";
	property name="ipAddress" ormType="string";
	property name="urlEndpoint" ormtype="string";
	property name="urlQueryString" ormtype="string";
	property name="params" ormtype="string";
	property name="resultsCount" ormtype="integer";
	property name="collectionConfig" ormtype="string" length="8000" hb_auditable="false" hb_formFieldType="json";
	property name="currentPage" ormtype="integer";
	property name="pageShow" ormtype="integer";
	property name="statusCode" ormType="string";
	property name="requestType" ormType="string";
