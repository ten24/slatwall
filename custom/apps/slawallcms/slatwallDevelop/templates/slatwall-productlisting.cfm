...
<div class="container" ng-cloak>
	...
	<div ng-if="slatwall.hasSuccessfulAction('addOrderItem')" class="alert alert-success">Item Added to Cart</div>
    <div ng-if="slatwall.hasFailureAction('addOrderItem')" class="alert alert-danger">There was an error adding item to cart</div>
    ...
    <cfset productCollectionList.addOrderBy("listingPages.sortOrder")>
    ...
    <cfset productCollectionList.setInlistDelimiter("||") />
		        		...
		        		<div class="col-lg-4 col-md-6 mb-4">
		    				<div class="card h-100">
		    					...
		    					<div class="card-body">
		                            ...
		                            <h5><a href="/#$.slatwall.setting('globalURLKeyProduct')#/#local.product['urlTitle']#">#local.product['productName']#</a></h5>
		                            ...
		                            <cfif local.product['defaultSku_listPrice'] GT local.product['defaultSku_price']>
		                            	<s class="float-right small">#$.slatwall.getService('hibachiUtilityService').formatValue(local.product['defaultSku_listPrice'],'currency')#</s>
		                            </cfif>
		    						<p>#$.slatwall.getService('hibachiUtilityService').formatValue(local.product['defaultSku_price'],'currency')#</p>
