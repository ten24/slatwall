				...
				<table class="table table-bordered table-hover">
					...
					<cfloop array="#rc.order.getOrderItems()#" index="orderItem">
						<tr>
							...
							<td><input type="text" name="orderItems[#orderItemIndex#].price" value="#val(precisionEvaluate(orderItem.getExtendedPriceAfterDiscount() / orderItem.getQuantity()))#" class="span1 number" /></td>
