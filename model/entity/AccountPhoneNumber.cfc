...
*/
component displayname="Account Phone Number" entityname="SlatwallAccountPhoneNumber" table="SwAccountPhoneNumber" persistent="true" accessors="true" output="false" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="accountService" hb_permission="account.accountPhoneNumbers" {
