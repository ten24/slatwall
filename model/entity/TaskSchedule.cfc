...
*/
component entityname="SlatwallTaskSchedule" table="SwTaskSchedule" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="scheduleService" hb_permission="task.taskSchedules" {
