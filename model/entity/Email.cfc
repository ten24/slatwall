...
*/
component entityname="SlatwallEmail" table="SwEmail" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="emailService" hb_permission="this" {
