...
component accessors="true" output="false" extends="Slatwall.model.transient.ResponseBean" {
	...
	public void function addTaxRateItem(any orderItemID, any referenceObjectID="",any taxAmount,any taxRate, string referenceObjectType="OrderItem", any VATPrice, any VATAmout) {
