...
/// <reference path="../../admin/client/ts/services/collectionconfigservice.ts" />
...
/// <reference path="../../admin/client/ts/directives/common/swentityactionbar.ts" />

/// <reference path="../../admin/client/ts/directives/common/swentityactionbarbuttongroup.ts" />

/// <reference path="../../admin/client/ts/directives/common/swexpandablerecord.ts" />
...
/// <reference path="../../admin/client/ts/directives/common/swlistingcolumn.ts" />

/// <reference path="../../admin/client/ts/directives/common/swlistingdisplay.ts" />

/// <reference path="../../admin/client/ts/directives/common/swloading.ts" />

/// <reference path="../../admin/client/ts/directives/common/swlogin.ts" />

/// <reference path="../../admin/client/ts/directives/common/swnumbersonly.ts" />
...
/// <reference path="../../admin/client/ts/directives/common/swprocesscaller.ts" />
...
/// <reference path="../../admin/client/ts/directives/frontend/swfForm.ts" />

/// <reference path="../../admin/client/ts/directives/frontend/swfFormField.ts" />

/// <reference path="../../admin/client/ts/directives/frontend/swfPropertyDisplay.ts" />
