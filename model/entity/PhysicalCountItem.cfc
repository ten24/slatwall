...
*/
component entityname="SlatwallPhysicalCountItem" table="SwPhysicalCountItem" persistent="true" accessors="true" extends="Slatwall.model.entity.HibachiEntity" cacheuse="transactional" hb_serviceName="physicalService" hb_permission="this" {
