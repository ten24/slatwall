...
<cfoutput>
	...
	<cfset rc.orderCollectionlist.addDisplayProperty(displayProperty='account.accountNumber',columnConfig={
		isVisible=true,
		isSearchable=true,
		isDeletable=true
	})/>	
	...
	<cfset rc.orderCollectionlist.addDisplayProperty(displayProperty='calculatedTotal',columnConfig={
		isVisible=true,
		isSearchable=true,
		isDeletable=true
		})/>	
