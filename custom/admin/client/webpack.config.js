...
devConfig.resolve.modules=[path.resolve(path.join(customPath, '../../../admin/client'), 'src/'),path.resolve(path.join(customPath, '../../client'), 'src/'),path.resolve(__dirname, 'src/'),'node_modules'];
