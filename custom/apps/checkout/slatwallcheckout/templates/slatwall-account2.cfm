...
<cfoutput>
	<div class="container">
		...
		<cfelse>
			...
			<div class="row">
				<!--- LOGIN --->
				<div class="span6" ng-init="loginObject = 'Account_Login'">
					
					<h5>Login with Existing Account</h5>		

					<!--- Start: Login Form --->
					<sw-form name="loginForm" data-object="loginObject" data-action="login" on-success="refresh:window">

						<!--- Email Address --->
						<div class="control-group">
		  					<sw-form-field data-name="emailAddress" data-label-text="Email Address" data-field-type="email" data-property="emailAddress" data-class="span6"></sw-form-field>
	  						<sw-error-display data-property="email"></sw-error-display>
						</div>

						<!--- Password --->
	  					<div class="control-group">
		  					<sw-form-field data-name="password" data-label-text="Password" data-field-type="password" data-property="password"
		  						data-class="span6"></sw-form-field>
	  						<sw-error-display data-property="password"></sw-error-display>
						</div>

						<!--- Login Button --->
						<sw-action-caller data-class="btn btn-primary" data-type="button" data-text="Login & Continue"></sw-action-caller>
					</sw-form>
					<!--- End: Login Form --->
					...
					<!--- Sets up the forgot password processObject --->
					<span ng-init="forgotPasswordObject = 'Account_ForgotPassword'"></span>
					
					<!--- Start: Forgot Password Form --->
					<sw-form name="forgotPasswordForm" data-object="forgotPasswordObject" data-action="forgotPassword">

						<sw-form name="forgotPasswordSuccess" class="hidden")>
							<div class="alert alert-success">
						...
						<div class="control-group">
		  					<sw-form-field data-name="emailAddress" data-label-text="Email Address" data-field-type="email" data-property="emailAddress" data-class="span6"></sw-form-field>
	  						<sw-error-display data-property="emailAddress"></sw-error-display>
						</div>
						
						<!--- Reset Email Button --->
						<sw-action-caller data-class="btn" data-type="button" data-text="Send Me Reset Email"></sw-action-caller>
				...
				<!--- CREATE ACCOUNT --->
				<div class="span6" ng-init="createAccountObject = 'Account_Create'">
					<h5>Create New Account</h5>
					
					<!--- Create Account Form --->
					<sw-form name="createAccountForm" data-object="createAccountObject" data-action="createAccount">
						
						<!--- This is passed so that we force the creation of a password and this isn't just a guest checkout and we'll delete this once it clearly works anyways
						...
						<div class="row">
							...
							<div class="control-group span3" >
	    						<sw-form-field data-name="firstName" data-label-text="First Name" data-field-type="text" data-property="firstName" data-class="span3"></sw-form-field>
		  						<sw-error-display data-property="firstName"></sw-error-display>
		  					</div>
							
							<!--- Last Name --->
							<div class="control-group span3">
	    						<sw-form-field data-name="lastName" data-label-text="Last Name" data-field-type="text" data-property="lastName" data-class="span3"></sw-form-field>
		  						<sw-error-display data-property="lastName"></sw-error-display>
		  					</div>
						...
						<!--- Phone Number --->
						<div class="control-group">
	    					<sw-form-field data-name="phoneNumber" data-label-text="Phone Number" data-field-type="text" data-property="phoneNumber" data-class="span6"></sw-form-field>
	  						<sw-error-display data-property="phoneNumber"></sw-error-display>
	  					</div>
						...
						<div class="control-group">
	    					<sw-form-field data-name="emailAddressConfirm" data-label-text="Confirm Email Address" data-field-type="email" data-property="emailAddressConfirm" data-class="span6"></sw-form-field>
	  						<sw-error-display data-property="emailAddressConfirm"></sw-error-display>
	  					</div>
						
						<!--- Password --->
						<div class="control-group">
	    					<sw-form-field data-name="password" data-label-text="Password" data-field-type="password" data-property="password" data-class="span6"></sw-form-field>
	  						<sw-error-display data-property="password"></sw-error-display>
	  					</div>
						
						<!--- Password Confirm --->
						<div class="control-group">
	    					<sw-form-field data-name="passwordConfirm" data-label-text="Confirm Password" data-field-type="password" data-property="passwordConfirm" data-class="span6"></sw-form-field>
	  						<sw-error-display data-property="passwordConfirm"></sw-error-display>
	  					</div>
						
						<!--- Create Button --->
						<div class="control-group pull-right">
	    					<sw-action-caller data-class="btn btn-primary" data-type="button" data-text="Create Account & Continue"></sw-action-caller>
	  					</div>
